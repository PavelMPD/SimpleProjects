...
public partial class Search_FormsTitle : SearchPage
{
	...
	protected override string HeaderScreenTitle
	{
		get
		{
			return PXMessages.LocalizeNoPrefix(Messages.scrFormSearch);
		}
	}
	...
	protected override bool PerformSearch(string query, bool isQuick)
	{
		...
		PXFormsTitleSearch search = new PXFormsTitleSearch();
		...
		foreach (PXFormsTitleSearch.Result res in searchResults)
		{
