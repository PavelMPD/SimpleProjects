...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" ActionsPosition="Top"
        AllowSearch="true" DataSourceID="ds" BatchUpdate="true" AdjustPageSize="Auto" SkinID="Inquire" Caption="Documents">
        <Levels>
            <px:PXGridLevel DataMember="INDocumentList">
                ...
                <Columns>
                    <px:PXGridColumn AllowNull="False" DataField="Selected" AllowCheckAll="True" Width="60px" TextAlign="Center" Type="CheckBox" />
