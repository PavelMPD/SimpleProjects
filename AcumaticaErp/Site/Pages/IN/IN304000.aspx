...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
            ...
            <px:PXTabItem Text="Transaction Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100; left: 0px; top: 0px;" Width="100%"
                        ActionsPosition="top" SkinID="DetailsInTab" StatusField="Availability">
                        <AutoSize Enabled="True" MinHeight="150" />
                        <Mode InitNewRow="True" AllowUpload="True" />
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Bin/Lot/Serial" Key="cmdLS" CommandName="LSINTran_binLotSerial" CommandSourceID="ds" DependOnGrid="grid" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 360px;"
        Width="764px" Caption="Bin/Lot/Serial Numbers" DesignView="Hidden" CaptionVisible="True" Key="lsselect" AutoCallBack-Command="Refresh"
