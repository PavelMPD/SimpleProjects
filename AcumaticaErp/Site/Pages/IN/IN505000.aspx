...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	...
	BatchUpdate="true" AllowPaging="true" AdjustPageSize="Auto" TabIndex="100" 
		SkinID="Inquire" Caption="Details">	
	    <Levels>
			<px:PXGridLevel DataMember="INItemList" >
				...
				<Columns>
					...
					<px:PXGridColumn AllowUpdate="False" DataField="InventoryCD" DisplayFormat="&gt;AAA-&gt;CCC-&gt;AA" Width="81px" />
					...
					<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="INSiteStatusSummary__QtyNotAvail" NullText="0.0" TextAlign="Right" Width="100px" />										
				</Columns>
			</px:PXGridLevel>
		</Levels>
