...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100" ActionsPosition="Top" AutoAdjustColumns="True"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Records">
                ...
                <Columns>
                    <px:PXGridColumn DataField="PriceClassID" DisplayFormat="&gt;aaaaaaaaaa" Width="90px" />
