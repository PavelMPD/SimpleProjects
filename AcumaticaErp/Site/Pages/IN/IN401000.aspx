...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Width="100%" TypeName="PX.Objects.IN.InventorySummaryEnq" PageLoadBehavior="PopulateSavedValues"
        ...
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ViewItem" Visible="False" DependOnGrid="grid" />
            <px:PXDSCallbackCommand Name="ViewAllocDet" Visible="False" DependOnGrid="grid" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="144px" Style="z-index: 100; left: 0px; top: 0px;" Width="100%"
        AdjustPageSize="Auto" AllowPaging="True" AllowSearch="True" Caption="Inventory Summary" BatchUpdate="True" SkinID="Inquire"
        TabIndex="8" RestrictFields="True">
        <Levels>
        ...
        <ActionBar DefaultAction="AllocDet">
            <CustomItems>
                <px:PXToolBarButton Key="item" Text="View Inventory Item">
                    <AutoCallBack Enabled="true" Target="ds" Command="ViewItem" />
                </px:PXToolBarButton>
                <px:PXToolBarButton Text="View Allocation Details" Key="AllocDet" CommandName="ViewAllocDet" CommandSourceID="ds" />
            </CustomItems>
        </ActionBar>
    </px:PXGrid>
</asp:Content>
