...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" 
		...
		SkinID="Inquire" Caption="Details" AdjustPageSize="Auto" AllowPaging="True" 
        TabIndex="300">	
	    <Levels>
			<px:PXGridLevel DataMember="INItemList" >
				...
				<Columns>
					...
					<px:PXGridColumn AllowUpdate="False" DataField="InventoryID" Width="81px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="SiteID" Width="81px"/>
					<px:PXGridColumn AllowUpdate="False" DataField="InvtAcctID" Width="45px" />
					<px:PXGridColumn AllowUpdate="False" DataField="InvtSubID" Width="72px" />
