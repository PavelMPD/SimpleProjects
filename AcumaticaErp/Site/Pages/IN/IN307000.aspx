...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="DocumentProperties">
        ...
        <Items>
            <px:PXTabItem Text="Stock Components">
                <Template>
                    <px:PXGrid runat="server" ID="componentsGrid" DataSourceID="ds" SkinID="DetailsInTab" Width="100%" 
                        StatusField="Availability" TabIndex="10300">
                        <Mode InitNewRow="True" />
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Bin/Lot/Serial" Key="cmdLS" CommandName="LSINComponentTran_binLotSerial" CommandSourceID="ds" DependOnGrid="componentsGrid">
                                </px:PXToolBarButton>
                            </CustomItems>
                        </ActionBar>
                        <Levels>
            ...
            <px:PXTabItem Text="Bin/Lot/Serial Numbers">
                <Template>
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 360px;"
        Width="764px" Caption="Bin/Lot/Serial Numbers" DesignView="Content" CaptionVisible="True" Key="lsselect" AutoCallBack-Command="Refresh"
