...
<Activity HighlightColor="" SelectedColor="" Width="" Height=""></Activity>
	    ...
	    <Template>
			...
			<px:PXSegmentMask CommitChanges="True" Height="18px" ID="edSiteID" 
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	<px:PXGrid ID="grid" runat="server" Height="144px" 
		...
		Caption="Details" DataSourceID="ds" SkinID="Inquire">
		<Levels>
			<px:PXGridLevel  DataMember="ResultPreview">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="OldMC" Width="55px" />
                    <px:PXGridColumn DataField="MCFixed" TextAlign="Center" Type="CheckBox" Width="35px" />
					<px:PXGridColumn DataField="NewMC" Width="55px" />	
				</Columns>
			</px:PXGridLevel>
		</Levels>
