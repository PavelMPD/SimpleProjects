...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="postclass"
        ...
        <AutoSize Container="Window" Enabled="True" MinHeight="72" />
        <Template>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="513px" DataSourceID="ds" DataMember="postclassaccounts">
        <Items>
            <px:PXTabItem Text="Posting Settings">
                <Template>
                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" />
                    <px:PXDropDown ID="edInvtAcctDefault" runat="server" AllowNull="False" DataField="InvtAcctDefault" />
                    ...
                    <px:PXDropDown ID="edStdCstVarAcctDefault" runat="server" AllowNull="False" DataField="StdCstVarAcctDefault" />
                    <px:PXSegmentMask ID="edStdCstVarSubMask" runat="server" DataField="StdCstVarSubMask" />
                    <px:PXDropDown ID="edStdCstRevAcctDefault" runat="server" AllowNull="False" DataField="StdCstRevAcctDefault" />
                    <px:PXSegmentMask ID="edStdCstRevSubMask" runat="server" DataField="StdCstRevSubMask" />
                    <px:PXDropDown ID="edPOAccrualAcctDefault" runat="server" AllowNull="False" DataField="POAccrualAcctDefault" />
                    <px:PXSegmentMask ID="edPOAccrualSubMask" runat="server" DataField="POAccrualSubMask" />
                    <px:PXDropDown ID="edPPVAcctDefault" runat="server" AllowNull="False" DataField="PPVAcctDefault" />
