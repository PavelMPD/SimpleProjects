            ...
            <px:PXTabItem Text="Location Table">
                <Template>
                    <px:PXPanel ID="locationForm" runat="server" Style="z-index: 100" Width="100%" CaptionVisible="False">
                        ...
                        <px:PXSegmentMask ID="edReceiptLocationID" runat="server" DataField="ReceiptLocationID" DataSourceID="ds" AutoRefresh="True">
                            <AutoCallBack Command="Save" Target="tab" />
                        </px:PXSegmentMask>
                        <px:PXSegmentMask ID="edShipLocationID" runat="server" DataField="ShipLocationID" DataSourceID="ds" AutoRefresh="True">
                            <AutoCallBack Command="Save" Target="tab" />
                        </px:PXSegmentMask>
                        <px:PXLayoutRule runat="server" StartColumn="True" ControlSize="SM" LabelsWidth="SM" />
                        <px:PXSegmentMask ID="edReturnLocationID" runat="server" DataField="ReturnLocationID" DataSourceID="ds"  AutoRefresh="True"/>
                        <px:PXSegmentMask ID="edDropShipLocationID" runat="server" DataField="DropShipLocationID" DataSourceID="ds"  AutoRefresh="True"/>
                    </px:PXPanel>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="location" DataKeyNames="SiteID,LocationCD">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PrimaryItemID" Width="108px"/>
