...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Revaluation Summary" TemplateContainer="">
		<Template>
			...
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="S" />
			<px:PXSelector ID="edLastAPFinPeriodID" runat="server" DataField="LastAPFinPeriodID" Enabled="False" />
			<px:PXNumberEdit ID="edTotalRevalued" runat="server" AllowNull="False" DataField="TotalRevalued" Enabled="False" /></Template>
	</px:PXFormView>
</asp:Content>
