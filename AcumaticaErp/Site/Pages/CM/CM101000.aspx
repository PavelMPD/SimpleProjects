...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="formSettings" runat="server" DataSourceID="ds" Width="100%" 
        DataMember="cmsetup" Caption="CM Settings" TemplateContainer="" TabIndex="900" >
		...
		<Template>
			...
			<px:PXCheckBox ID="chkMCActivated" runat="server" DataField="MCActivated" />
			<px:PXSelector ID="edBatchNumberingID" runat="server" 
                DataField="BatchNumberingID" AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXSelector ID="edTranslNumberingID" runat="server" 
                DataField="TranslNumberingID" AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXSelector ID="edExtRefNbrNumberingID" runat="server" AllowEdit="True" 
                DataField="ExtRefNbrNumberingID" DataSourceID="ds" edit="1">
            </px:PXSelector>
			...
			<px:PXNumberEdit Size="XXS" ID="edRetainPeriodsNumber" runat="server" DataField="RetainPeriodsNumber" />
			<px:PXLabel Size="m" ID="lblPeriodsNumberAfter" runat="server">Periods</px:PXLabel>
			...
			<px:PXSelector ID="edTranslDefId" runat="server" DataField="TranslDefId" 
                AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Default Rate Types" />
			<px:PXSelector ID="edGLRateTypeDflt" runat="server" DataField="GLRateTypeDflt" 
                AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXSelector ID="edGLRateTypeReval" runat="server" 
                DataField="GLRateTypeReval" AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXSelector ID="edCARateTypeDflt" runat="server" DataField="CARateTypeDflt" 
                AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXSelector ID="edARRateTypeDflt" runat="server" DataField="ARRateTypeDflt" 
                AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXSelector ID="edARRateTypeReval" runat="server" 
                DataField="ARRateTypeReval" AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXSelector ID="edAPRateTypeDflt" runat="server" DataField="APRateTypeDflt" 
                AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXSelector ID="edAPRateTypeReval" runat="server" 
                DataField="APRateTypeReval" AllowEdit="True" DataSourceID="ds" edit="1" />
			<px:PXLayoutRule runat="server" StartColumn="True" ControlSize="M" LabelsWidth="M" />
			<px:PXFormView ID="basecurrency" runat="server" RenderStyle="Simple" 
                DataMember="basecurrency" DataSourceID="ds" TabIndex="1100" >
				<Template>
					<px:PXLayoutRule runat="server" StartColumn="True" ControlSize="M" LabelsWidth="M" />
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Rounding Settings" />
