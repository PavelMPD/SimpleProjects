...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="TranslationParamsFilter" PageLoadBehavior="PopulateSavedValues" TypeName="PX.Objects.CM.TranslationProcess">
		<CallbackCommands>
			<px:PXDSCallbackCommand CommitChanges="true" Name="translate" StartNewGroup="true" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="150px" Style="z-index: 100;" Width="100%" AllowPaging="True" Caption="Rate Details" ActionsPosition="top" AllowSearch="true" SkinID="Details">
		<Levels>
