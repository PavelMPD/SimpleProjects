        ...
        <Items>
            ...
            <px:PXTabItem Text="GL Accounts">
                <Template>
					...
					<px:PXSegmentMask ID="edPrebookAcctID" runat="server" AllowEdit="True" CommitChanges="True" DataField="PrebookAcctID">
					</px:PXSegmentMask>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataKeyNames="SourceID,SetupID" DataMember="NotificationSources">
                                        <RowTemplate>
                                            ...
                                            <px:PXSegmentMask ID="edNBranchID" runat="server" DataField="NBranchID" DataMember="_Branch_" />
