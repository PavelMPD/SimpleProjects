			...
			<px:PXTabItem Text="Document List">
				<Template>
					<px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" 
						Style="z-index: 100" AllowPaging="True" AllowSearch="true" DataSourceID="ds"  BorderWidth="0px" SkinID="Details" MatrixMode="True">
						<Levels>
							<px:PXGridLevel DataMember="Document_Detail" >
								<RowTemplate>
									...
									<px:PXSelector ID="edFinPeriodID" runat="server" DataField="FinPeriodID" Enabled="False" AllowEdit="True" />
									...
									<px:PXTextEdit ID="edDocDesc" runat="server" DataField="DocDesc"  /></RowTemplate>
								<Columns>
						...
						<%--<ActionBar>
							<CustomItems>
								<px:PXToolBarButton Text="View Document" CommandName="ViewDocument" 
									CommandSourceID="ds" />
							</CustomItems>
						</ActionBar>--%>
				...
				<Template>
					<px:PXGrid ID="grid2" runat="server" Height="400px" Width="100%" 
						...
						<Levels>
							<px:PXGridLevel DataMember="Document_History" >
								<RowTemplate>
									...
									<px:PXSelector ID="edFinPeriodID2" runat="server" DataField="FinPeriodID" Enabled="False" AllowEdit="True" />
									...
									<px:PXTextEdit ID="edDocDesc2" runat="server" DataField="DocDesc"  /></RowTemplate>
								<Columns>
									<px:PXGridColumn AllowUpdate="False" DataField="DocType" Type="DropDownList" Width="100px" />
						...
						<ActionBar>
							...
							<%--<CustomItems>
								<px:PXToolBarButton Text="View Document" CommandName="ViewGenDocument" 
									CommandSourceID="ds" />
							</CustomItems>--%>
						</ActionBar>
						<AutoSize Enabled="True" MinHeight="100" MinWidth="100" />
