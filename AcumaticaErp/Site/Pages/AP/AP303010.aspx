...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" LabelsWidth="SM" Height="540px" Style="z-index: 100" Width="100%" DataMember="LocationCurrent">
		...
		<Items>
				...
				<Template>
					...
					<px:PXFormView ID="Address" runat="server" DataMember="Address" SyncPosition="true" RenderStyle="Simple" LabelsWidth="SM">
						<Template>
							...
							<px:PXSelector ID="edCountryID" runat="server" DataField="CountryID" CommitChanges="True" AllowEdit="True" LabelsWidth="SM" />
							<px:PXSelector ID="edState" runat="server" AutoRefresh="True" DataField="State" AllowEdit="True" LabelsWidth="SM" />
							<px:PXLayoutRule runat="server" Merge="True" />
			...
			<px:PXTabItem Text="GL Accounts">
				<Template>
					...
					<px:PXSegmentMask CommitChanges="True" ID="edVFreightAcctID" runat="server" DataField="VFreightAcctID" />
