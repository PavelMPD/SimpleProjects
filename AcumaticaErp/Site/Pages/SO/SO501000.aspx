...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edAction">
        ...
        <Template>
            ...
            <px:PXSegmentMask CommitChanges="True" Height="18px" ID="edSiteID" runat="server" DataField="SiteID" /></Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" AllowPaging="true" AdjustPageSize="Auto" SkinID="Details"
        AllowSearch="true" BatchUpdate="true" Caption="Orders" FastFilterFields="OrderNbr,CustomerID,CustomerID_BAccountR_acctName,OrderDesc,CustomerOrderNbr">
        <Levels>
        ...
        <ActionBar>
            <CustomItems>
                <px:PXToolBarButton CommandSourceID="ds" CommandName="ViewDocument" Text="View Document" />
            </CustomItems>
        </ActionBar>
    </px:PXGrid>
</asp:Content>
