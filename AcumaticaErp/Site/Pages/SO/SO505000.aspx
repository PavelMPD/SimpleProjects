...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="true" AdjustPageSize="Auto"
        AllowSearch="true" DataSourceID="ds" BatchUpdate="True" SkinID="Inquire" Caption="Documents">
        <Levels>
            <px:PXGridLevel DataMember="SOInvoiceList">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="RefNbr" Width="90px" />
        ...
        <ActionBar>
            <CustomItems>
                <px:PXToolBarButton Text="View Document">
                    <AutoCallBack Command="ViewDocument" Enabled="True" Target="ds">
