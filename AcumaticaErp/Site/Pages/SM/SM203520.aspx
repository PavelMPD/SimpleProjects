...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXUploadDialog ID="dlgUploadFile" runat="server" Key="UploadDialogPanel" Height="60px" Style="position: static" Width="450px"
		Caption="Upload Snapshot Package" AutoSaveFile="false" SessionKey="UploadedSnapshotKey" AllowedTypes=".zip" IgnoreSize="true"
	...
	<px:PXSmartPanel ID="pnlImportSnapshot" runat="server" CaptionVisible="True" Caption="Restore Snapshot"
		ForeColor="Black" Style="position: static" Width="415px" LoadOnDemand="true"
		Key="ImportSnapshotPanel" AutoCallBack-Enabled="True" AutoCallBack-Target="frmEditObjectCommand"
		AutoCallBack-Command="Refresh" AutoCallBack-ActiveBehavior="true" 
		AutoCallBack-Behavior-RepaintControlsIDs="ftmImportSnapshot">
		<px:PXFormView ID="ftmImportSnapshot" runat="server" SkinID="Transparent" DataMember="ImportSnapshotPanel"
			DataSourceID="ds" Width="100%" EmailingGraph="">
			<Activity Height="" Width="" />
			<Template>
				<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" 
					ControlSize="M" />
				<px:PXLabel ID="lblImportWarning" runat="server" Encode="True">
					WARNING: This action will overwrite all data in this company.
				</px:PXLabel>
	...
	<px:PXSmartPanel ID="pnlExportSnapshot" runat="server" CaptionVisible="True" Caption="Create Snapshot"
		ForeColor="Black" Style="position: static"  Width="415px" LoadOnDemand="true"
		Key="ExportSnapshotPanel" AutoCallBack-Enabled="True" AutoCallBack-Target="frmEditObjectCommand"
		AutoCallBack-Command="Refresh" AutoCallBack-ActiveBehavior="true" 
		AutoCallBack-Behavior-RepaintControlsIDs="frmExportSnapshot" 
		DesignView="Content">
		<px:PXFormView ID="frmExportSnapshot" runat="server" SkinID="Transparent" DataMember="ExportSnapshotPanel" DataSourceID="ds">
			<Template>
				...
				<px:PXCheckBox ID="chkCustomization" runat="server" DataField="Customization" />
				<px:PXCheckBox ID="chkPrepare" runat="server" DataField="Prepare" />
			</Template>
		</px:PXFormView>		
	...
	<px:PXSmartPanel ID="pnlCopyCompany" runat="server" CaptionVisible="True" Caption="Copy Company"
		ForeColor="Black" Style="position: static" Height="120" Width="410px" LoadOnDemand="True"
		Key="CopyCompanyPanel" AutoCallBack-Target="frmEditObjectCommand"
		AutoCallBack-Command="Refresh" DesignView="Content">
		<px:PXFormView ID="frmCopyCompany" runat="server" SkinID="Transparent" DataMember="CopyCompanyPanel"
			DataSourceID="ds" Width="355px" EmailingGraph="">
			<Template>
				<px:PXLayoutRule runat="server" ControlSize="M" LabelsWidth="SM" 
					StartColumn="True">
				</px:PXLayoutRule>
	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXTextEdit ID="edCompanyCD" runat="server" DataField="CompanyCD" Enabled="False" />
			...
			<px:PXTextEdit ID="edCompanyName" runat="server" DataField="CompanyName" Enabled="False" />
			<px:PXCheckBox CommitChanges="True" ID="chkHidden" runat="server" DataField="Hidden" />
					...
					<px:PXGrid ID="gridSnapshots" runat="server" DataSourceID="ds" Style="position: static"
						...
						<Levels>
							<px:PXGridLevel DataMember="Snapshots">
								<Columns>
                                    ...
                                    <px:PXGridColumn AllowUpdate="False" DataField="Size" Label="File Size (in megabytes)" Width="145px" />
						...
						<ActionBar>
							...
							<CustomItems>
								...
								<px:PXToolBarButton Text="Prepare Snapshot" Tooltip="Prepare current snapshot for downloading.">
