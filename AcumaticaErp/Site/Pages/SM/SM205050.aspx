...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXSmartPanel ID="pnlViewMessage" runat="server" CaptionVisible="True" Caption="View Message" Width="800px" 
		...
		<px:PXFormView ID="frmViewMessage" runat="server" SkinID="Transparent" DataMember="HistoryCurrent"
			...
			<Template>
				...
				<px:PXTextEdit ID="edAddressTo" runat="server" DataField="MailTo" />
				...
				<pxa:PXRichTextEdit ID="rteBody"  runat="server" DataField="BodyVirtual" TextMode="MultiLine" Height="300px" >
