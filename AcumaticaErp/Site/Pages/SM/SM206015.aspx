		...
		<px:PXFormView ID="frmEditObjectCommand" runat="server" SkinID="Transparent" DataMember="CurrentObject"
			...
			<Template>
				...
				<px:PXTextEdit Height="228px" ID="edCommand" runat="server" DataField="Command" CommitChanges="True" 
					TextMode="MultiLine" Width="550px" /></Template>
		</px:PXFormView>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
			...
			<px:PXTabItem Text="Parameters" LoadOnDemand="True">
				<Template>
					<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px;
						height: 270px;" Width="100%" SkinID="DetailsInTab" AutoAdjustColumns="True" MatrixMode="True"
    ...
    <px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="450">
          ...
          <Template1>
								<px:PXGrid ID="gridObjects" runat="server" DataSourceID="ds" Style="z-index: 100;
									left: 0px; height: 270px;" Width="100%" SkinID="DetailsInTab" AutoAdjustColumns="True"
          ...
          <Template2>
								...
								<px:PXGrid ID="gridFields" runat="server" DataSourceID="ds" Style="z-index: 100;
									left: 0px; height: 270px;" Width="100%" SkinID="DetailsInTab" AutoAdjustColumns="True"
