...
<Activity Width="" Height=""></Activity>
		<Template>
			...
			<px:PXCheckBox ID="chkUpdateElevated" runat="server" DataField="UpdateElevated" CommitChanges="true" />
			<px:PXTextEdit ID="edUpdateLogin" runat="server" DataField="UpdateLogin"  />
			<px:PXTextEdit ID="edUpdatePassword" runat="server" DataField="UpdatePassword" TextMode="Password" />
			<px:PXLayoutRule runat="server" GroupCaption="Storage Settings" 
				StartGroup="True">
			</px:PXLayoutRule>
