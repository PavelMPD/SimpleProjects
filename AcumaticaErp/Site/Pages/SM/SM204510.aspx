...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" Caption="Selected Project"
		DataMember="Projects" DataSourceID="ds" >
		<Template>
			...
			<px:PXSelector ID="edName" runat="server" DataField="Name" 
				AutoGenerateColumns="True" DataSourceID="ds" NullText="<NEW>"  />
	...
	<px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300" SkinID="Horizontal" Height="500px">
		...
		<Template1>
			<px:PXGrid ID="grid" runat="server" Width="100%"
				SkinID="DetailsInTab" AutoAdjustColumns="True" SyncPosition="True" FilesIndicator="True" NoteIndicator="False">
				...
				<ActionBar Position="Top">
					...
					<CustomItems>
						<px:PXToolBarButton Text="Add">
								<MenuItems>
								<px:PXMenuItem Text="File from File System" PopupPanel="FilterSelectFile" />
								    <px:PXMenuItem Text="New Graph, Dac, Code File" >
								        <AutoCallBack Enabled="True" Target="ds" Command="actionNewFile" />
								    </px:PXMenuItem>
<%--								<px:PXMenuItem Text="Generic Inquiry">
									<AutoCallBack Command="actionGenInq" Target="ds" />
								</px:PXMenuItem>--%>
								<px:PXMenuItem Text="Generic Inq">
									<AutoCallBack Command="actionGI" Target="ds" />
								</px:PXMenuItem>
                                 <px:PXMenuItem Text="Site Map">
									<AutoCallBack Command="actionSiteMap" Target="ds" />
								</px:PXMenuItem>
								<px:PXMenuItem Text="Report from Database">
									<AutoCallBack Command="actionReports" Target="ds" />
								</px:PXMenuItem>
								<px:PXMenuItem Text="Database Table or Script">
									<AutoCallBack Command="actionTableNew" Target="ds" />
								</px:PXMenuItem>
						...
						<px:PXToolBarButton>
							<AutoCallBack Target="ds" Command="actionEditItem" />
						</px:PXToolBarButton>
						<px:PXToolBarButton>
							<AutoCallBack Target="ds" Command="actionOpenScreen" />
						</px:PXToolBarButton>
						<px:PXToolBarButton>
							<AutoCallBack Enabled="True" Target="ds" Command="actionRefreshDbTables" />
						</px:PXToolBarButton>
						<px:PXToolBarButton Text="Checkin Files..." PopupPanel="PanelCheckinFiles" />
					</CustomItems>
				</ActionBar>
				<Levels>
		...
		<Template2>
			<px:PXFormView runat="server" ID="PanelSource" Caption="Source" Width="100%" DataMember="EditObject"
				OverflowY="Hidden" Height="200px" AllowPaging="False" BorderStyle="None" SkinID="Inside" 
				...
				<Template>
					<px:PXTextEdit spellcheck='false' runat="server" ID="edSource" TextMode="MultiLine"
						Width="100%" Height="200px" DataField="Content" Style="font-family: Monospace;
						overflow: scroll;" Font-Size="10pt" Font-Names="Courier New" Wrap="False" SelectOnFocus="False"
						BorderStyle="None" SuppressLabel="True">
						<AutoSize Enabled="True" />
					</px:PXTextEdit>
				</Template>
			</px:PXFormView>
