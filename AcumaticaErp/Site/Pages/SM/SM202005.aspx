...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">	
	<pxa:DynamicDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.SM.WikiSetupMaint,PX.SM.WikiMaintenance"
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="DITA" PopupVisible="False" />
	...
	<px:PXTab ID="tab" runat="server" Height="211px" Style="z-index: 100" Width="100%">
		...
		<Items>
			...
			<px:PXTabItem Text="Scripts">
				<Template>
					<px:PXGrid ID="gridAnalytics" runat="server" Width="100%" Height="54px" DataSourceID="ds"
						AdjustPageSize="Auto" ActionsPosition="Top" BorderWidth="0px" SkinID="DetailsInTab">
						<Levels>
							<px:PXGridLevel DataMember="Analytics">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
									<px:PXSelector ID="edNPageID" runat="server" DataField="NPageID" ValueField="Name" />
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="NPageID" Width="300px" />
								</Columns>
								<Layout FormViewHeight="" />
							</px:PXGridLevel>
						</Levels>
