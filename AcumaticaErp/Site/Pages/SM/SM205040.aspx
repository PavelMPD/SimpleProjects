			...
			<px:PXTabItem Text="Message" BindingContext="formNotification" VisibleExp="DataControls[&quot;chkIsEmbeded&quot;].Value == False">
				<Template>
					<pxa:PXRichTextEdit ID="wikiEdit" runat="server" Style="z-index: 113; border-width: 0px;"
						...
						AllowLinkEditor="true" AllowInsertParameter="true">
						<ContentStyle BorderStyle="None" />
						<AutoSize Enabled="True" />
                        <InsertParameter DataSourceID="ds" DataMember="EntityItems" TextField="Name" ValueField="Path"
							ImageField="Icon" />
						<ImageEditor DataSourceID="ds" DataMember="$NoteImages$AUNotification" ValueField="FileID"
							TextField="Name">
							<Columns>
						...
						<Levels>
							<px:PXGridLevel DataKeyNames="ScreenID,NotificationID,RowNbr" DataMember="Addresses">
								...
								<RowTemplate>
									...
									<px:PXSelector ID="edEmail" runat="server" DataField="Email" DataMember="_EMailSource_"
