					...
					<px:PXGrid ID="gridMapping" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
						...
						<ActionBar>
							...
							<CustomItems>
							    ...
							    <pxa:PXGridCombo ListItems="Select Commands Visibility,Hide Service Commands,Show All Commands" ParameterName="whatToShow"
						...
						<Levels>
							<px:PXGridLevel DataMember="FieldMappings">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="ObjectName" Width="150px" AutoCallBack="True" Type="DropDownList" MatrixMode="false" DynamicValueItems="true" />
