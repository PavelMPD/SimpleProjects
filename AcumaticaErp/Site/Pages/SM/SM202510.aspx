...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXTextEdit ID="edCheckedOutBy" runat="server" DataField="CheckedOutBy" DataMember="_Users_"
				Enabled="False" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="288px" LoadOnDemand="True"
		...
		<Items>
			...
			<px:PXTabItem Text="Screens" Visible="false">
				<Template>
					<px:PXGrid ID="gridScreens" runat="server" AutoAdjustColumns="True" DataSourceID="ds"
						Height="200px" Style="position: static" Width="100%" ActionsPosition="Top" BorderWidth="0px"
						SkinID="DetailsInTab">
						<Levels>
							<px:PXGridLevel DataMember="FilesInScreensRecords" 
								DataKeyNames="FileID,ScreenID">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
									<px:PXTextEdit ID="edScreenID" runat="server" DataField="ScreenID" />
								</RowTemplate>
								<Columns>
						...
						<ActionBar>
							...
							<CustomItems>
								<px:PXToolBarButton Text="View Screen">
			...
			<px:PXTabItem Text="Access Rights" RepaintOnDemand="false" Tooltip="Shows access rights for the file."
				...
				<Template>
					...
					<px:PXLabel ID="PXHole" runat="server" Width="145px" >Access Rights</px:PXLabel>
					<px:PXGrid ID="gridRights" runat="server" Height="320px" Width="300px" 
						...
						<Levels>
							<px:PXGridLevel DataMember="WikiAccessRightsRecs" 
								...
								<Columns>
									<px:PXGridColumn DataField="RoleName" Width="250px" />
