...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<pxa:DynamicDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Prefs"
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand CommitChanges="True" Name="EMailAccount_View" Visible="False"
				DependOnGrid="gridEMail" />
			<px:PXDSCallbackCommand CommitChanges="True" Name="EMailAccount_Delete" Visible="False"
				DependOnGrid="gridEMail" />
		</CallbackCommands>
		...
		<Levels>
			<px:PXGridLevel DataMember="EMailAccounts">
				...
				<RowTemplate>
					...
					<px:PXTextEdit ID="edPassword" runat="server" DataField="Password" /></RowTemplate>
			</px:PXGridLevel>
		</Levels>
