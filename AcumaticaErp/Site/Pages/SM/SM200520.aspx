...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" Width="100%" runat="server" PrimaryView="Children" 
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand DependOnGrid="grid" Name="cut" />
		</CallbackCommands>
		<DataTrees>
				...
				<Levels>
					<px:PXGridLevel DataMember="Children">
						<RowTemplate>
							...
							<px:PXSelector ID="edGraphtype" runat="server" DataField="Graphtype" Enabled="False" > </px:PXSelector>
