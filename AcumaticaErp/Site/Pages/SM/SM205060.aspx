	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" Caption="Selection"
		...
		<Template>
			...
			<px:PXSelector CommitChanges="True" Size="M" ID="edUsername" runat="server" DataField="Username"
				DataMember="_Users_" TextField="username" DataSourceID="ds" />
		...
		<Levels>
			<px:PXGridLevel DataMember="Templates">
				<RowTemplate>
					...
					<px:PXLayoutRule runat="server" />
					<px:PXSelector ID="edScreenID" runat="server" DataField="ScreenID" DataMember="_SiteMap_" />
					<px:PXSelector ID="edUsername" runat="server" DataField="Username" DataMember="_Users_"
						TextField="username" />
