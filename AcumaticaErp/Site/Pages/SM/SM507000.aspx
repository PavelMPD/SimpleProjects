...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%"
		...
		<Template>
			...
			<px:PXLabel ID="PXLabel1" runat="server" Width="71px" Style="margin-left: 9px" Text="Assigned to:"/>
			<px:PXCheckBox ID="PXCheckBox1" runat="server" DataField="MyOwner" Size="XXS" Width="48px">
		...
		<Levels>
			<px:PXGridLevel DataMember="FilteredItems">
				<Columns>
					...
					<px:PXGridColumn DataField="EMailAccount__Description" Width="300px" />
					...
					<px:PXGridColumn DataField="StartDate" Width="90px" DataType="DateTime" />
					<px:PXGridColumn DataField="Owner"  Width="90px" DisplayMode="Text"/>
				</Columns>
