...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	...
	<script language="javascript" type="text/javascript">
		...
		PXSmartPanel.prototype.onAfterResize = function (mouse) {
			if (this.ID == pnlPreparedDataID)// pnlPreparedDataID is registered by server
			{
				setGridHeight(this, px_all[gridPreparedID]); //gridPreparedID is registered by server
				px_all[gridPreparedID].adjustPage(true);
			}
			px_cm.notifyOnResize(this, mouse);
		}
	</script>
</asp:Content>
