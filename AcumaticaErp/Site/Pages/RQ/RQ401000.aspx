...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" TypeName="PX.Objects.RQ.RQRequestEnq"
		...
		<CallbackCommands>
			<px:PXDSCallbackCommand Name="Details" Visible="false" DependOnGrid="grid" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
		Width="100%" ActionsPosition="Top" Caption="Requests" SkinID="Inquire" RestrictFields="True">
		...
		<ActionBar  DefaultAction="Details">
			<CustomItems>
				<px:PXToolBarButton Text="Document Details" Tooltip="Show Document Details" Key="Details">
