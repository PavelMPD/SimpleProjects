...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <px:PXSmartPanel ID="pnlAddRequest" runat="server" Key="SourceRequests" DesignView="Content" CaptionVisible="true" Caption="Select Requested Items" Width="900px"
        Height="400px" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True" AutoCallBack-Target="formRequest" CallBackMode-CommitChanges="True" CallBackMode-PostData="Page"
        ...
        <px:PXGrid ID="addRequest" runat="server" DataSourceID="ds" Width="100%" Style="border-width: 1px 0px; top: 0px; left: 0px;">
