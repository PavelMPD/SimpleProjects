...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" Caption="Orders"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Records">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="EmployeeID_EPEmployee_acctName" Width="108px" />
        ...
        <ActionBar DefaultAction="Details">
            <CustomItems>
                <px:PXToolBarButton Text="Order Details" Tooltip="Order Details" Key="Details">
