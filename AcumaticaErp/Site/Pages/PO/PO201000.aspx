...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="BAccount" TypeName="PX.Objects.PO.POVendorCatalogueMaint"
		...
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Name="UpdateVendorPrice" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" AllowPaging="true" Style="z-index: 100" Width="100%" SkinID="Details" Caption="Vendor Inventory Details">
		<Levels>
			<px:PXGridLevel  DataMember="VendorCatalogue">
				...
				<Columns>
                    ...
                    <px:PXGridColumn DataField="InventoryItem__PurchaseUnit" Width="85px" />
                    ...
                    <px:PXGridColumn DataField="PendingPrice" TextAlign="Right" Width="100px" AllowNull="False" />
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="EffDate" Width="90px" />
