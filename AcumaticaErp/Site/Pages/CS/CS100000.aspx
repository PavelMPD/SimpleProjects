...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" 
		...
		<Template>
		    ...
		    <px:PXLabel ID="PXLabel2" runat="server" Text="Use this screen to enable the selected Acumatica ERP features."/>
            ...
            <px:PXLabel runat="server"/>		    
            <px:PXLabel runat="server" Text="<B>WARNING</B>: Features cannot be disabled if they have been used."/>
		    <px:PXLayoutRule GroupCaption="Features" runat="server" StartRow="True" StartColumn="True" StartGroup="True" ControlSize="L" LabelsWidth="xxs"/>            		    
		</Template>
