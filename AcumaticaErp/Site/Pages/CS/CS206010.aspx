...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXSmartPanel ID="pnlRenumber" runat="server" Style="z-index: 108;" CaptionVisible="True" Caption="Set Numbering Step" Key="fltNumberingStep" AutoReload="True">
		<px:PXFormView ID="frmNumberStep" runat="server" DataMember="fltNumberingStep" SkinID="Transparent" Style="z-index: 100" TemplateContainer="" Width="100%" DataSourceID="ds" TabIndex="32300">
			<Template>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="280px" Style="z-index: 100; top: 0px;" Width="100%" Caption="Rows" ActionsPosition="Top" AutoAdjustColumns="True" SkinID="Details">
		<Levels>
			<px:PXGridLevel DataMember="Rows">
				...
				<Columns>
					<px:PXGridColumn DataField="RowCode" />
					<px:PXGridColumn DataField="Description" Width="180px" />
					<px:PXGridColumn DataField="RowType" Type="DropDownList" Width="100px" />
					<px:PXGridColumn DataField="Formula" Width="180px" />
					<px:PXGridColumn AllowUpdate="False" DataField="DataSourceID" TextField="DataSourceIDText" Width="180px" />
					<px:PXGridColumn AllowUpdate="False" DataField="StyleID" TextField="StyleIDText" Width="120px" />
					<px:PXGridColumn DataField="PrintControl" Type="DropDownList" Width="100px" RenderEditorText="True" />
					<px:PXGridColumn DataField="PageBreak" TextAlign="Center" Type="CheckBox" Width="60px" />
					<px:PXGridColumn DataField="Height" TextAlign="Right" Width="54px" />
					<px:PXGridColumn DataField="Indent" TextAlign="Right" Width="54px" />
					<px:PXGridColumn DataField="LineStyle" Type="DropDownList" Width="80px" />
					<px:PXGridColumn DataField="SuppressEmpty" TextAlign="Center" Type="CheckBox" Width="60px" />
					<px:PXGridColumn DataField="HideZero" TextAlign="Center" Type="CheckBox" Width="60px" />
					<px:PXGridColumn DataField="LinkedRowCode" Width="60px" />
					<px:PXGridColumn DataField="ColumnGroupID" Width="60px" />
