...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="TermsDef" Caption="Credit Terms" DefaultControlID="edTermsID" DataSourceID="ds" TabIndex="2500">
		<Template>
			...
			<px:PXNumberEdit Size="XXS" LabelWidth="71px" ID="edDayTo00" runat="server" DataField="DayTo00" />
			<px:PXLayoutRule runat="server" Merge="True" />
			<px:PXNumberEdit ID="edDayDue01" runat="server" DataField="DayDue01" Size="XXS" />
			<px:PXNumberEdit Size="XXS" LabelWidth="71px" ID="edDayFrom01" runat="server" DataField="DayFrom01" />
			...
			<px:PXNumberEdit Size="XXS" ID="edDayDisc" runat="server" DataField="DayDisc" />
			...
			<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Caption="Installments Schedule" AllowSearch="True" SkinID="Details" Height="250px" Width="400px" TabIndex="2700">
				<Levels>
					<px:PXGridLevel DataMember="Installments" DataKeyNames="TermsID,InstallmentNbr">
						<Columns>
							<px:PXGridColumn DataField="InstallmentNbr" TextAlign="Right" Width="50px" AllowUpdate="False" />
						...
						<RowTemplate>
							...
							<px:PXNumberEdit ID="edInstallmentNbr" runat="server" DataField="InstallmentNbr" />
