...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<script language="javascript" type="text/javascript">
		function grdRefreshTree() {
			setTimeout(function() { refreshTree() }, 1);
		}

		function refreshTree() {
			var tree = px_all["ctl00_phG_tree"];
			var node = tree.selectedNode;

			if (node != null) {
				if (node.parentNode == null || node.parentNode == tree.rootNode)
					tree.refresh();
				else {
    ...
    <px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300">
          ...
          <Template1>
				<px:PXTreeView ID="tree" runat="server" DataSourceID="ds"   PopulateOnDemand="True" AutoRepaint="True" RootNodeText="Units" ExpandDepth="4"
                    ShowRootNode="False" Caption="Unit Code" AllowCollapse="False" CaptionVisible="False">
				    <ToolBarItems>
...
<%--						<px:PXToolBarButton Tooltip="Move up" CommandSourceID="ds" CommandName="up">
          ...
          <Template2>
				<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Width="100%" ActionsPosition="Top" Caption="Units" 
                AutoAdjustColumns="true" CaptionVisible="False">
					<ClientEvents AfterRowInsert="grdRefreshTree" AfterRowDelete="grdRefreshTree" AfterRowUpdate="grdRefreshTree"></ClientEvents>
					<Levels>
