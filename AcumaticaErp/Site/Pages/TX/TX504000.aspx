...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="Filter" Caption="Selection" LinkPage="">
		...
		<Template>
			...
			<px:PXSelector CommitChanges="True" ID="edTaxZoneID" runat="server" DataField="TaxZoneID" DataKeyNames="TaxZoneID" DataMember="_TaxZone_" DataSourceID="ds" InputMask="&gt;aaaaaaaaaa" MaxLength="10" />
			<px:PXSelector CommitChanges="True" ID="edTaxID" runat="server" DataField="TaxID" DataKeyNames="TaxID" DataMember="_Tax_" DataSourceID="ds" InputMask="&gt;aaaaaaaaaa" MaxLength="10" />
		</Template>
	</px:PXFormView>
</asp:Content>
