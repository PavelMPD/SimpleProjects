<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="TX503000.aspx.cs" Inherits="Page_TX503000" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" Visible="true" runat="server" TypeName="PX.Objects.TX.ProcessPendingVAT" PrimaryView="CustomerSVAT">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	<px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" AllowPaging="True" AllowSearch="true" AdjustPageSize="Auto" DataSourceID="ds" ActionsPosition="Top" BatchUpdate="true" SkinID="Inquire" Caption="Transactions">
		<Levels>
			<px:PXGridLevel DataMember="CustomerSVAT">
				<Columns>
