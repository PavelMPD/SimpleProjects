...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.TX.ReportTax" PrimaryView="Period_Header" PageLoadBehavior="PopulateSavedValues">
		<CallbackCommands>
			<px:PXDSCallbackCommand Name="FileTax" PostData="Self" StartNewGroup="true" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="grid" runat="server" Height="150px" Width="100%" ActionsPosition="Top" Caption="Details" SkinID="Details">
		<Levels>
			<px:PXGridLevel DataMember="Period_Details">
				<RowTemplate>
					...
					<px:PXNumberEdit SuppressLabel="True" ID="edTaxHistory__ReportUnfiledAmt" runat="server" DataField="TaxHistory__ReportUnfiledAmt" />
				</RowTemplate>
				<Columns>
