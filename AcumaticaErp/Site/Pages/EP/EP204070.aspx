...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Caption="Event Settings"
        ...
        <Template>
            ...
            <px:PXLayoutRule ID="PXLayoutRule10" runat="server" StartGroup="True" GroupCaption="Misc" />
            <px:PXSelector ID="edDefTasksFilterID" runat="server" DataField="DefTasksFilterID" ValueField="FilterID" TextField="FilterName" AllowEdit="True" DataSourceID="ds" edit="1" />
            <px:PXSelector ID="edDefEventsFilterID" runat="server" DataField="DefEventsFilterID" ValueField="FilterID" TextField="FilterName" AllowEdit="True" 
