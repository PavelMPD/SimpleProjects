...
<asp:content id="cont2" contentplaceholderid="phF" runat="Server">
	...
	<px:PXFormView ID="frmSnooze" runat="server" Width="100%" DataSourceID="ds" DataMember="DeferFilter" OverflowY="Hidden">
		<Template>
			...
			<px:PXPanel runat="server" ID="panel2" RenderStyle="Simple" ContentLayout-OuterSpacing="Around" Style="float:right">
				...
				<px:PXButton ID="btnViewActivity" runat="server" Text="Open" Width="90px" AlignLeft="true">
					<AutoCallBack Command="ViewActivity" Enabled="true" Target="ds" />
					<PopupCommand Command="Refresh" Enabled="true" Target="ds" />
				</px:PXButton>
				<px:PXButton ID="btnDismissCurrent" runat="server" Text="Dismiss" Width="90px" >
					<AutoCallBack Command="DismissCurrent" Enabled="true" Target="ds" />
				</px:PXButton>
				<px:PXButton ID="btnDismissAll" runat="server" Text="Dismiss All" Width="90px" >
