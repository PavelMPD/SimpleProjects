<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="EP402000.aspx.cs" Inherits="Page_EP402000" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.EP.MyExpenseClaimsEnq"
        PrimaryView="Filter">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" TabIndex="100">
		<Template>
			...
			<px:PXLayoutRule ID="PXLayoutRule2" runat="server" StartColumn="True"  LabelsWidth="XS" ControlSize="XS" />
            ...
            <px:PXLayoutRule ID="PXLayoutRule3" runat="server" StartColumn="True"  LabelsWidth="XS" ControlSize="XS" />
		...
		<Levels>
			<px:PXGridLevel DataMember="ExpenseClaimRecords" >
				<RowTemplate>
                    ...
                    <px:PXTextEdit ID="edAPinvoiceStatus" runat="server" DataField="APInvoice__Status" />
                    <px:PXTextEdit ID="edAPinvoiceCuryOrigDocAmt" runat="server" DataField="APInvoice__CuryOrigDocAmt" />
                </RowTemplate>
				<Columns>
					...
					<px:PXGridColumn AllowNull="False" DataField="APInvoice__Status" TextAlign="Right" Width="81px"/>
                    <px:PXGridColumn AllowNull="False" DataField="APInvoice__CuryOrigDocAmt" TextAlign="Right" Width="120px" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
		<ActionBar>
