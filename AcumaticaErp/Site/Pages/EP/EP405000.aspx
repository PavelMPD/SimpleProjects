...
<asp:Content ID="cont3" ContentPlaceHolderID="phF" runat="server">
	<pxa:PXGridWithPreview ID="gridActivities" runat="server" DataSourceID="ds" Width="100%" Height="420px" 
		...
		<Levels>
			<px:PXGridLevel  DataMember="Activities">
				<Columns>
					...
					<px:PXGridColumn DataField="Owner" LinkCommand="OpenActivityOwner" Width="150px" />
		...
		<PreviewPanelTemplate>
			<pxa:PXHtmlView ID="edBody" runat="server" DataField="previewHtml" TextMode="MultiLine" MaxLength="50"
