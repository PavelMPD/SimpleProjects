    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <Columns>
                    <px:PXGridColumn AllowNull="False" DataField="Selected" TextAlign="Center" Type="CheckBox" Width="20px" AllowCheckAll="True" />
                    <px:PXGridColumn AllowUpdate="False" DataField="ContractCD" Width="120px" LinkCommand="ViewContract"/>
