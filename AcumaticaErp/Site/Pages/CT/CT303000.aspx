...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter"
        ...
        <CallbackCommands>
            ...
            <%--<px:PXDSCallbackCommand Name="ViewInvoice" Visible="False" DependOnGrid="BilledGrid" />--%>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%"
        ...
        <Template>
            ...
            <px:PXSelector CommitChanges="True" ID="edContractID" runat="server" DataField="ContractID"  /></Template>
    </px:PXFormView>
</asp:Content>
                    ...
                    <px:PXGrid runat="server" ID="UnbilledGrid" Height="100%" Width="100%" DataSourceID="ds"
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="TranID" DataMember="UnBilled">
                                ...
                                <Columns>
                                    <%--<px:PXGridColumn AutoGenerateOption="NotSet" DataField="TranID" Label="ID" Width="81px">
                                        <Header Text="ID">
                                        </Header>
                                    </px:PXGridColumn>--%>
                                    ...
                                    <px:PXGridColumn DataField="BAccountID" Label="Customer" Width="108px" AutoCallBack="true" />
                ...
                <Template>
                    <px:PXFormView ID="UsageFilterForm" runat="server" Width="100%" Caption="Selection"
                        ...
                        <Template>
                            ...
                            <px:PXSelector CommitChanges="True" ID="edInvFinPeriodID" runat="server" DataField="InvFinPeriodID"  /></Template>
                    </px:PXFormView>
                    <px:PXGrid runat="server" ID="BilledGrid" Width="100%" DataSourceID="ds" Caption="Billed Usage"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Billed">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="LocationID" Label="Location" Width="63px" />
                                    <px:PXGridColumn DataField="UOM" Label="UOM" Width="108px" />
                                    ...
                                    <px:PXGridColumn DataField="ARRefNbr" Label="AR Reference Nbr." Width="108px" />
                                    <px:PXGridColumn DataField="BilledDate" Label="Billed Date" Width="90px" />
                                    <px:PXGridColumn DataField="CRCase__CaseCD" Width="90px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
