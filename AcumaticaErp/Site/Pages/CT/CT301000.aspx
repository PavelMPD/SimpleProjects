...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXSmartPanel ID="PanelActivate" runat="server" AcceptButtonID="PXButtonOK" AutoReload="true" CancelButtonID="PXButtonCancel"
        Caption="Activate Contract" CaptionVisible="True" DesignView="Content" HideAfterAction="false" Key="ActivationSettings"
        LoadOnDemand="true" Height="160px" Width="320px">
        <px:PXFormView ID="formActivationSettings" runat="server" CaptionVisible="False" DataMember="ActivationSettings" Width="100%"
    ...
    <px:PXSmartPanel ID="PanelTerminate" runat="server" AcceptButtonID="PXButtonOK" AutoReload="true" CancelButtonID="PXButtonCancel"
        ...
        LoadOnDemand="true" Height="160px" Width="320px">
        <px:PXFormView ID="PXFormView2" runat="server" CaptionVisible="False" DataMember="TerminationSettings" Width="100%"
	...
	<px:PXSmartPanel ID="PanelOnDemand" runat="server" AcceptButtonID="PXButtonOK" AutoReload="true" CancelButtonID="PXButtonCancel"
        ...
        LoadOnDemand="true" Height="160px" Width="320px">
        <px:PXFormView ID="PXFormView5" runat="server" CaptionVisible="False" DataMember="OnDemandSettings" Width="100%"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ContractDetails">
                                <RowTemplate>
                                    ...
                                    <%--<px:PXNumberEdit runat="server" ID="edItemBasePrice" DataField="ContractItem__ItemBasePrice"  />--%>
                                    ...
                                    <px:PXNumberEdit runat="server" ID="edFixedRecurringPriceVal" DataField="FixedRecurringPriceVal" />
                                ...
                                <Columns>
                                    ...
                                    <%--<px:PXGridColumn DataField="ContractItem__ItemBasePrice" Width="90px" />--%>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="RenewalHistory">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edUser" runat="server" AllowEdit="True" DataField="RenewedBy" />
                ...
                <Template>
                    <px:PXGrid ID="InvoicesGrid" runat="server" Height="350px" Width="100%" Style="z-index: 100" AllowPaging="True" AdjustPageSize="Auto"
                        ...
                        <ActionBar DefaultAction="cmdViewInvoice">
                            <CustomItems>
                                <px:PXToolBarButton Text="View Details" Key="cmdViewInvoice" CommandName="ViewInvoice" CommandSourceID="ds" />
                            </CustomItems>
                        </ActionBar>
                        <Levels>
