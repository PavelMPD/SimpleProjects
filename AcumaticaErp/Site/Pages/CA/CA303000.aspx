...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" PageLoadBehavior="PopulateSavedValues" TypeName="PX.Objects.CA.CATranEnq">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand CommitChanges="True" Name="AddDet" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXSmartPanel ID="AddFilterPanel" Key="AddFilter" runat="server" Caption="Quick Transaction" CaptionVisible="True" CommandName="addDet" CommandSourceID="ds" AutoCallBack-Target="AddFilter" AutoCallBack-Command="Refresh"
		Overflow="Hidden">
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" ActionsPosition="Top" Caption="Cash Transactions" AllowPaging="true" AdjustPageSize="Auto" SkinID="Details">
		<Levels>
			<px:PXGridLevel DataMember="CATranListRecords">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="OrigTranType" Type="DropDownList" Width="80px" />
					...
					<%--<px:PXGridColumn DataField="ReferenceID_Description" Width="200px" />--%>
				</Columns>
			</px:PXGridLevel>
		</Levels>
		...
		<ActionBar DefaultAction="cmdDoubleClick">
			<CustomItems>
				<px:PXToolBarButton Text="Create Transaction" Key="cmdAddDet" PopupPanel="AddFilterPanel" />
