...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" DataSourceID="ds" Height="300px" Width="100%" DataMember="PaymentMethodCurrent">
		<Items>
			<px:PXTabItem Text="Allowed Cash Accounts" LoadOnDemand="True">
				<Template>
					<px:PXGrid ID="grdCashAccounts" runat="server" DataSourceID="ds" Height="150px" Width="100%" BorderWidth="0px" SkinID="Details" TabIndex="22500">
						...
						<Levels>
							<px:PXGridLevel DataMember="CashAccounts" DataKeyNames="PaymentMethodID,CashAccountID">
								<RowTemplate>
									...
									<px:PXSegmentMask ID="edCashAccountID" runat="server" DataField="CashAccountID" AllowEdit="True" /></RowTemplate>
								<Columns>
			...
			<px:PXTabItem Text="Settings for Use in AR" LoadOnDemand="False" RepaintOnDemand="False" BindingContext="form" VisibleExp="DataControls[&quot;chkUseForAR&quot;].Value = 1">
				<Template>
						...
						<Levels>
							<px:PXGridLevel DataMember="DetailsForReceivable" SortOrder="OrderIndex">
								<Columns>
									...
									<px:PXGridColumn AutoCallBack="True" DataField="IsIdentifier" TextAlign="Center" Type="CheckBox" Width="60px" AllowShowHide="Server" />
									<px:PXGridColumn DataField="IsExpirationDate" TextAlign="Center" Type="CheckBox" Width="60px" AllowShowHide="Server" AutoCallBack="True" />
                                    <px:PXGridColumn AllowShowHide="Server" AutoCallBack="True" DataField="IsOwnerName" TextAlign="Center" Type="CheckBox" Width="60px" />
									<px:PXGridColumn DataField="IsCCProcessingID" TextAlign="Center" Type="CheckBox" Width="60px" AllowShowHide="Server" />
			...
			<px:PXTabItem Text="Settings for Use in AP" VisibleExp="DataControls[&quot;chkUseForAP&quot;].Value = 1" BindingContext="form">
				<Template>
					<px:PXPanel ID="pnlPrintCheck" runat="server" RenderSimple="True" ContentLayout-OuterSpacing="Around" RenderStyle="Simple">
						<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Check Printing Settings" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
						<px:PXCheckBox CommitChanges="True" ID="chkAPPrintChecks" runat="server" DataField="APPrintChecks" />
						<px:PXSelector CommitChanges="True" ID="edAPCheckReportID" runat="server" DataField="APCheckReportID" AutoGenerateColumns="True" />
						...
						<px:PXSelector CommitChanges="True" ID="edRemittanceReportID" runat="server" DataField="APRemittanceReportID" AutoGenerateColumns="True" ValueField="ScreenID" />
						<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Export Settings" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
						<px:PXCheckBox CommitChanges="True" ID="chkAPCreateBatchPayment" runat="server" DataField="APCreateBatchPayment" />
						<px:PXSelector CommitChanges="True" ID="edAPBatchExportSYMappingID" runat="server" DataField="APBatchExportSYMappingID" />
					</px:PXPanel>
