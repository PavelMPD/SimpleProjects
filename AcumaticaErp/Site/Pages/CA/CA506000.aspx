...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" DataSourceID="ds" AllowSearch="true" SkinID="Inquire" Caption="Financial Periods">
        <Levels>
            <px:PXGridLevel DataMember="PeriodList">
                <RowTemplate>
                    ...
                    <px:PXTextEdit ID="edDescr" runat="server" DataField="Descr" Enabled="False" /></RowTemplate>
                <Columns>
