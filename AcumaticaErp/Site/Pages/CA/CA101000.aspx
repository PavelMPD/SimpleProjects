...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<%--<px:PXFormView ID="form" runat="server" Height="599px" Width="100%" DataMember="CASetupRecord" Caption="General Settings" TabIndex="11700" DataSourceID="ds">--%>
		...
		<Items>
			...
			<%--<px:PXSelector ID="edCuryRateTypeID" runat="server" DataField="CuryRateTypeID" DataSourceID="ds" />--%>
			...
			<px:PXGrid ID="gridApproval" runat="server" Width="350px" Height="200px" TabIndex="11900" DataSourceID="ds">
				<Levels>
					<px:PXGridLevel DataMember="Approval">
						...
						<Columns>
							<px:PXGridColumn DataField="AssignmentMapID" Width="300px" RenderEditorText="True" TextField="AssignmentMapID_EPAssignmentMap_Name" />
						</Columns>
		...
		<px:PXTabItem Text="Bank Statement Settings">
			<Template>
				...
				<px:PXLayoutRule runat="server" LabelsWidth="XXS" ControlSize="M" StartGroup="True" GroupCaption="Import Settings"/>
