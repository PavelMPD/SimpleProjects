<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormView.master" AutoEventWireup="true"
    ValidateRequest="false" CodeFile="SP408031.aspx.cs" Inherits="Page_SP408031" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormView.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="SP.Objects.SP.CustomerBusinessAccountMaint" PrimaryView="BAccount" PageLoadBehavior="SearchSavedKeys">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="MergeBAccount" Visible="False" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataMember="BAccount" DataSourceID="ds" NoteIndicator="False" FilesIndicator="False" Visible="False">
    	<Template>
			<px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
            <px:PXSelector ID="edAcctCD" runat="server" DataField="AcctCD" FilterByAllFields="True" CommitChanges="True" AutoRefresh="True" Visible="False"/>
		</Template>
    </px:PXFormView>
        ...
        <Template>
            ...
            <px:PXFormView ID="frmDefContact" runat="server" CaptionVisible="False" DataMember="DefContact"
                ...
                <Template>
                    ...
                    <px:PXTextEdit ID="edSalutation" runat="server" DataField="Salutation" Enabled="False"/>
                    ...
                    <px:PXTextEdit ID="edEMail" runat="server" DataField="EMail" CommandName="NewMailActivity"
                        CommandSourceID="ds" CommitChanges="True" Enabled="False"/>
                    <px:PXTextEdit ID="edWebSite" runat="server" DataField="WebSite" CommitChanges="True" Enabled="False"/>
                    <px:PXMaskEdit ID="edPhone1" runat="server" DataField="Phone1" Enabled="False"/>
                    <px:PXMaskEdit ID="edPhone2" runat="server" DataField="Phone2" Enabled="False"/>
                    <px:PXMaskEdit ID="edFax" runat="server" DataField="Fax" Enabled="False"/>
                </Template>
            ...
            <px:PXFormView ID="frmDefAddress" runat="server" CaptionVisible="False" DataSourceID="ds" DataMember="AddressCurrent" SkinID="Transparent">
                <Template>
                    <px:PXLayoutRule ID="PXLayoutRule8" runat="server" StartGroup="True" GroupCaption="Main Address" />
                    ...
                    <px:PXSelector ID="edCountryID" runat="server" DataField="CountryID"
                        FilterByAllFields="True" TextMode="Search" DisplayMode="Hint" CommitChanges="True" Enabled="False"/>
                    <px:PXSelector ID="edState" runat="server" AutoRefresh="True" DataField="State" CommitChanges="true"
                        FilterByAllFields="True" TextMode="Search" DisplayMode="Hint"  Enabled="False"/>
                    <px:PXLayoutRule ID="PXLayoutRule15" runat="server" Merge="True" />
                    <px:PXMaskEdit ID="edPostalCode" runat="server" DataField="PostalCode" Size="S"  Enabled="False"/>
