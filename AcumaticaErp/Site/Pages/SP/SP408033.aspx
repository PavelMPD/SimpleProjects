...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Width="100%" TypeName="SP.Objects.SP.SPBussnessAccountInquire" PrimaryView="FilteredItems">
		<CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phL" runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px"
		...
		SkinID="Inquire" FastFilterFields="AcctCD,AcctName" AutoGenerateColumns="AppendDynamic">
		<Levels>
		...
		<ActionBar DefaultAction="cmdItemDetails" PagerVisible="False">
			<CustomItems>
				<px:PXToolBarButton Text="Business Accounts Details" Tooltip="Business Accounts Details" Key="cmdItemDetails" Visible="false">
