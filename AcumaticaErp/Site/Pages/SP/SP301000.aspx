        ...
        <Items>
            <px:PXTabItem Text="Summary" RepaintOnDemand="false">
                <Template>
                    ...
                    <px:PXCheckBox SuppressLabel="True" ID="chkAutoRenew" runat="server" DataField="AutoRenew" Enabled="False" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ContractDetails">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edContractItemID1" runat="server" DataField="ContractItemID" AllowEdit="true" AutoRefresh="true" />
