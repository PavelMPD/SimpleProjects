...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Case" Width="100%" AllowCollapse="False">
		<Template>
			<px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartColumn="True" LabelsWidth="S"
				ControlSize="M" />
			<px:PXSelector ID="edCaseCD" runat="server" DataField="CaseCD" FilterByAllFields="True" AutoRefresh="True" Size="S" />
			<px:PXDateTimeEdit ID="edCreatedDateTime" runat="server" DataField="CreatedDateTime" Enabled="False" Size="SM"/>
			<px:PXDateTimeEdit ID="edLastActivity" runat="server" DataField="LastActivity" Enabled="False" Size="SM"/>
			...
			<px:PXSelector ID="edContractID" runat="server" DataField="ContractID" FilterByAllFields="True" AutoRefresh="True" DisplayMode="Text" AutoAdjustColumns="True" />
			<px:PXSelector ID="edOwner" runat="server" DataField="OwnerID"  Enabled="False" DisplayMode="Text"/>
			
			<px:PXLayoutRule ID="PXLayoutRule10" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="SM" /> 
			<px:PXDropDown ID="PXTextEdit1" runat="server" DataField="Status" Enabled="False"/>
			<px:PXDropDown ID="PXTextEdit2" runat="server" DataField="Resolution" Enabled="False" AllowNull="False"/>
			<px:PXDropDown ID="PXTextEdit4" runat="server" DataField="Severity" Enabled="False"/>  
            <px:PXDropDown ID="PXTextEdit3" runat="server" DataField="Priority" Enabled="True"/>
		</Template>
	</px:PXFormView>
</asp:Content>
						...
						<Levels>
							<px:PXGridLevel DataMember="Activities">
								<Columns>
                                    ...
                                    <px:PXGridColumn AllowUpdate="False" DataField="CreatedByID_Creator_Username" Visible="false" Width="108px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
