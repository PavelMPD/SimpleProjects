	...
	<px:PXTab ID="tab" runat="server" Width="100%" DataSourceID="ds" DataMember="CaseCurrent">
		<Items>
			<px:PXTabItem Text="Details">
				<Template>
					<pxa:pxrichtextedit id="edDescription" runat="server" datafield="Description" style="border-top: 0px solid #BBBBBB;
						border-left: 0px; border-right: 0px; margin: 0px; padding: 0px; width: 100%;
						height: 100%;">
						<AutoSize Container="Parent" Enabled="True" MinHeight="216" />
					</pxa:pxrichtextedit>
				</Template>
			</px:PXTabItem>
