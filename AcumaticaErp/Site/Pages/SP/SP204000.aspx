...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="gridOpen" runat="server" DataSourceID="ds" ActionsPosition="Top" AllowPaging="true"
		AdjustPageSize="Auto" AllowSearch="true" SkinID="Inquire" Width="100%" MatrixMode="True" FastFilterFields="CaseCD,Subject">
		<Levels>
			<px:PXGridLevel DataMember="FilteredItems">
			   <Columns>
                    ...
                    <px:PXGridColumn DataField="Contract__Description" Width="200px" />
                    ...
                    <px:PXGridColumn DataField="OwnerID" Width="130px" />
                    <px:PXGridColumn DataField="Contract__CustomerID" Width="130px" />
