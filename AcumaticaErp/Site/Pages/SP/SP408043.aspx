...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Width="100%" TypeName="SP.Objects.SP.SPContactPartnerInquiry" PrimaryView="FilteredItems">
		<CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phL" runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
		...
		SkinID="Inquire" FastFilterFields="DisplayName,FullName" FilesIndicator="False" NoteIndicator="False">
		<Levels>
