...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Depreciation Method Summary"
        ...
        <Template>
            ...
            <px:PXDropDown ID="edDepreciationMethod" runat="server" DataField="DepreciationMethod"/>
            ...
            <px:PXNumberEdit ID="edTotalPercents" runat="server" DataField="TotalPercents" Enabled="False" />
        </Template>
    </px:PXFormView>
</asp:Content>
        ...
        <Levels>
            <px:PXGridLevel DataMember="details">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="RatioPerYear" TextAlign="Right" Width="100px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
