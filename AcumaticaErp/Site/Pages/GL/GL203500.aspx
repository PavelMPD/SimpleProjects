...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Width="100%" DataMember="Schedule_Header"
		...
		<Template>
			...
			<px:PXLayoutRule runat="server" Merge="True" LabelsWidth="XS"  ControlSize="XXS" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Batch_Detail">
								<RowTemplate>
									...
									<px:PXTextEdit ID="edCuryID" runat="server" DataField="CuryID" />
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="Module" Width="50px" Type="DropDownList" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Batch_History">
								<RowTemplate>
									...
									<px:PXSelector ID="edFinPeriodID2" runat="server" DataField="FinPeriodID" />
