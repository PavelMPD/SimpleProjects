					...
					<px:PXGrid ID="gridUsers" BorderWidth="0px" runat="server"  Height="150px"
							...
							<px:PXGridLevel DataMember="Users" DataKeyNames="Username">
								...
								<Columns>
									<px:PXGridColumn DataField="Included" TextAlign="Center" Type="CheckBox" Width="30px"
										AllowCheckAll="True" />
									<px:PXGridColumn DataField="Username" Width="300px" Visible="False" AllowShowHide="False" />
						...
						<ActionBar>
							<Actions>
								...
								<%--<EditRecord Text="Membership" ImageUrl="main@Settings" GroupIndex="2" Order = "0" />--%>
							</Actions>
						</ActionBar>
					</px:PXGrid>
				</Template>
					...
					<px:PXGrid ID="gridSubs" BorderWidth="0px" runat="server"  Height="150px"
						...
						<ActionBar>
							<Actions>
								...
								<Delete Enabled="False" />
                                <EditRecord Enabled="False" />
								<%--<EditRecord Text="Membership" ImageUrl="main@Settings" GroupIndex="3" Order = "0" />--%>
							</Actions>
						</ActionBar>
					</px:PXGrid>
				</Template>
