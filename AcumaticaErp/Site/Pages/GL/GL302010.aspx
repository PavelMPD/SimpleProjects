...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <script language="javascript" type="text/javascript">
        function showTreeChanged(owner, args)
    	{
    		...
    		px_alls["sp1"].setDisabledPanel(visible ? 0 : 1);
    	}
	    ...
	    function showTreeLoad(e)
	    {
	    	...
	    	setTimeout(function ()
	    	{
	    		pxs["form"].events.addEventHandler("afterRepaint", showTreeChk);
	    	}, 1);
	    }
	    var loaded = false;
				...
				<Levels>
					<px:PXGridLevel DataMember="BudgetArticles">
						<Columns>
							...
							<%--<px:PXGridColumn DataField="AccountMask" Width="80px" AutoCallBack="True" />
							<px:PXGridColumn DataField="SubMask" Width="108px" AutoCallBack="True" />--%>
							...
							<Template>
								...
								<px:PXGroupBox ID="gbPreloadMode" runat="server" CommitChanges="True" DataField="PreloadAction" RenderStyle="Simple">
									<Template>
										...
										<%--<px:PXRadioButton ID="prDelete" runat="server" GroupName="PreloadMode" Text="Delete and reload all Articles"
											Value="0" Size="XL" />--%>
