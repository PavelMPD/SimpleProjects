						...
						<Levels>
							<px:PXGridLevel DataMember="MapDetails" ImportDataMember="ImportTemplate">
								<RowTemplate>
									...
									<px:PXDropDown ID="edDisplayStatus" runat="server" DataField="DisplayStatus" Enabled="False" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="ImportAccountCD" Width="120px" />
									<px:PXGridColumn DataField="MapAccountID" Width="120px" />
									<px:PXGridColumn DataField="ImportSubAccountCD" Width="150px" />
									<px:PXGridColumn DataField="MapSubAccountID" Width="150px" />
									<px:PXGridColumn DataField="YtdBalance" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="CuryYtdBalance" TextAlign="Right" Width="100px"/>
						...
						<Levels>
							<px:PXGridLevel DataMember="Exceptions">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="ConsolAccountCD" Width="120px" />
								</Columns>
