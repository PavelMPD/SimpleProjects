					...
					<px:PXTabItem Text="Calculation Rules" RepaintOnDemand="false">
						<Template>
							<px:PXFormView ID="formRules" runat="server" DataSourceID="ds" DataMember="StepRules" Width="100%" SkinID="Transparent">
								<Template>
									<px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartColumn="True" ColumnWidth="L" />
									...
									<px:PXPanel ID="formSelection" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule8" runat="server" StartColumn="True" ColumnWidth="L" />
									...
									<px:PXPanel ID="PXFormView1" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule4" runat="server" StartColumn="True" ColumnWidth="L" />
						...
						<Template>
							<px:PXFormView ID="formSettings" runat="server" DataSourceID="ds" DataMember="StepSettings" Width="100%" SkinID="Transparent">
								<Template>
									...
									<px:PXPanel ID="formSelection" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule15" runat="server" StartColumn="True" ColumnWidth="L" />
										...
										<px:PXLayoutRule ID="PXLayoutRule88" runat="server" StartColumn="True" ColumnWidth="M"/>
									...
									<px:PXPanel ID="PXPanel1" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule16" runat="server" StartColumn="True" ColumnWidth="L"  />
										...
										<px:PXSelector ID="PXSelector1" runat="server" DataField="ProjectID" SuppressLabel="True" CommitChanges="True"/>
										<px:PXSelector ID="PXSelector2" runat="server" DataField="TaskID" SuppressLabel="True" CommitChanges="True"/>
										...
										<px:PXSelector ID="PXSelector10" runat="server" DataField="SubID" SuppressLabel="True" CommitChanges="True"/>
									...
									<px:PXPanel ID="PXPanel2" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule17" runat="server" StartColumn="True" ColumnWidth="L" />
										...
										<px:PXSelector ID="PXSelector5" runat="server" DataField="OffsetProjectID" SuppressLabel="True" CommitChanges="True"/>
										<px:PXSelector ID="PXSelector6" runat="server" DataField="OffsetTaskID" SuppressLabel="True" CommitChanges="True"/>
										...
										<px:PXSelector ID="PXSelector11" runat="server" DataField="OffsetSubID" SuppressLabel="True" CommitChanges="True"/>
									</px:PXPanel>
									...
									<px:PXPanel ID="PXPanel3" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule18" runat="server" StartColumn="True" ColumnWidth="L" />
