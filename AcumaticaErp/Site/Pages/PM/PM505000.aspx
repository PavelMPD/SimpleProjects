...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Selection" DataMember="Filter">
        <Template>
            ...
            <px:PXSelector CommitChanges="True" runat="server" DataMember="_PMBilling_" DataField="BillingID" ID="edBillingID" />
            <px:PXSelector CommitChanges="True" runat="server" DataMember="_CustomerClass_" DataField="CustomerClassID" ID="edCustomerClassID" />
            <px:PXSegmentMask CommitChanges="True" runat="server" DataMember="_BAccountR_AccessInfo.userName_" DataField="CustomerID"
                ID="edCustomerID" />
            <px:PXSegmentMask CommitChanges="True" runat="server" DataMember="_EPEmployee_" DataField="ResourceID" ID="edResourceID" />

            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
            <px:PXSegmentMask CommitChanges="True" runat="server" DataMember="_PMProject_" DataField="ProjectID" ID="edProjectID" />
            <px:PXSegmentMask CommitChanges="True" runat="server" DataMember="_PMTask_TranFilter.projectID_" DataField="ProjectTaskID"
                ID="edProjectTaskID" />
            <px:PXSegmentMask CommitChanges="True" runat="server" DataMember="_InventoryItem_AccessInfo.userName_" DataField="InventoryID"
                ID="edInventoryID" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="Inquire" AdjustPageSize="Auto"
        AllowPaging="True" Caption="Transactions">
        <Levels>
