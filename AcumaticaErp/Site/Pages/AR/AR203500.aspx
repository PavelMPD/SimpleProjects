			...
			<px:PXTabItem Text="Document List">
				<Template>
					<px:PXGrid ID="grid" runat="server" Height="100%" Width="100%" AllowSearch="true"
						...
						<Levels>
							<px:PXGridLevel DataMember="Document_Detail">
								<RowTemplate>
									...
									<px:PXLabel ID="lblCustomerID" runat="server">Customer ID :</px:PXLabel>
						...
						<ActionBar>
							<%--<CustomItems>
								<px:PXToolBarButton Text="View Document" CommandName="ViewDocument" CommandSourceID="ds" />
							</CustomItems>--%>
						</ActionBar>
			...
			<px:PXTabItem Text="Generated Documents">
				<Template>
					<px:PXGrid ID="grid2" runat="server" Height="100%" Width="100%" AllowSearch="true"
						...
						<Levels>
							<px:PXGridLevel DataMember="Document_History">
								<RowTemplate>
									...
									<px:PXLabel ID="lblCustomerID2" runat="server">Customer ID :</px:PXLabel>
									<px:PXDateTimeEdit ID="edDocDate2" runat="server" DataField="DocDate" Enabled="False" />
									<px:PXSelector ID="edFinPeriodID2" runat="server" DataField="FinPeriodID" Enabled="False" />
						...
						<ActionBar>
							<%--<CustomItems>
								<px:PXToolBarButton Text="View Document" CommandName="ViewGenDocument" CommandSourceID="ds" />
							</CustomItems>--%>
						</ActionBar>
						<AutoSize Enabled="True" MinHeight="100" MinWidth="100" />
					</px:PXGrid>
