...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Invoice Summary" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity"
		LinkIndicator="True" NotifyIndicator="True" DefaultControlID="edDocType" TabIndex="100">
		<CallbackCommands>
			<Save PostData="Self" />
		</CallbackCommands>
	...
	<px:PXTab ID="tab" runat="server" Height="300px" Style="z-index: 100;" Width="100%" TabIndex="200" DataMember="CurrentDocument">
		<Items>
			<px:PXTabItem Text="Document Details">
				<Template>
					<px:PXGrid ID="grid" runat="server" Style="z-index: 100;" Width="100%" SkinID="DetailsInTab" Height="300px" TabIndex="300" DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="Transactions" >
								<Columns>
									...
									<px:PXGridColumn DataField="TranType" Label="Tran. Type" Visible="False" />
									<px:PXGridColumn DataField="RefNbr" Label="Reference Nbr." Visible="False" />
								...
								<RowTemplate>
									...
									<px:PXSelector CommitChanges="True" ID="edDefScheduleID" runat="server" DataField="DefScheduleID" />
						...
						<ActionBar>
							<CustomItems>
								<px:PXToolBarButton NavigateUrl="~/Pages/AR/AR203500.aspx" Text="View Schedule" AutoPostBack="True">
									<NavigateParams>
										<px:PXControlParam ControlID="grid" Direction="Output" Name="ScheduleID" PropertyName="DataValues[&quot;ScheduleID&quot;]" Type="String" />
									</NavigateParams>
								</px:PXToolBarButton>
							</CustomItems>
						</ActionBar>
			...
			<px:PXTabItem Text="Financial Details">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Payment Information" StartGroup="True" />
					...
					<px:PXLayoutRule runat="server" ControlSize="M" GroupCaption="Tax and Commission" LabelsWidth="SM" StartColumn="True" StartGroup="True" />
					<px:PXSelector ID="edTaxZoneID" runat="server" CommitChanges="True" DataField="TaxZoneID" DataSourceID="ds" Text="ZONE1" />
