<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master"
	 AutoEventWireup="true" CodeFile="AR202020.aspx.cs" Inherits="Page_AR_AR202020" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" TypeName="PX.Objects.AR.ARCustomerSalesPriceMaint">
        <CallbackCommands>
        ...
        <Levels>
            <px:PXGridLevel DataMember="Records">
                <RowTemplate>
                    ...
                    <px:PXLayoutRule ID="PXLayoutRule8" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
						...
						<px:PXFormView ID="formPanel" runat="server" SkinID="Transparent" DataMember="MassCopySettings" MarkRequired="Dynamic">
							<Template>
								...
								<px:PXPanel ID="PXPanel2" runat="server" RenderStyle="Simple" Style="padding-left: 10px">
									<px:PXLayoutRule ID="PXLayoutRule14" runat="server" StartColumn="True" LabelsWidth="SM"
										ControlSize="M" />
        ...
        <div style="padding: 5px">
            <px:PXFormView ID="massUpdateForm" runat="server" Width="100%" DataSourceID="ds" SkinID="Transparent" DataMember="MassUpdateSettings">
                <Template>
                    ...
                    <px:PXDateTimeEdit ID="PXDateTimeEdit1" runat="server" DataField="EffectiveDate" />
                </Template>
            </px:PXFormView>
        </div>
