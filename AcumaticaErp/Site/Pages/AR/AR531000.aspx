...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" runat="server" PrimaryView="Filter" TypeName="PX.Objects.AR.ClaimRUTROT" Visible="true" >
		<CallbackCommands>
		...
		<Levels>
			<px:PXGridLevel DataKeyNames="DocType,RefNbr" DataMember="Documents">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="CuryRUTROTDistributedAmt" TextAlign="Right" Width="150px">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="RUTROTClaimDate" Width="90px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="RUTROTExportRefNbr" Width="90px">
                    </px:PXGridColumn>
                </Columns>
			</px:PXGridLevel>
		</Levels>
