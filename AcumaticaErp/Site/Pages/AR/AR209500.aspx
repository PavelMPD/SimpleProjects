...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Sequence" TypeName="PX.Objects.SO.ARDiscountSequenceMaint"
        BorderStyle="NotSet">
        <CallbackCommands>
    ...
    <px:PXTab ID="tab" runat="server" Height="540px" Style="z-index: 100" Width="100%">
        <Items>
            <px:PXTabItem Text="Discount Breakpoints">
                <Template>
                    <px:PXGrid runat="server" ID="grid" DataSourceID="ds" Height="144px" BorderStyle="None" SkinID="Details" Width="100%" AdjustPageSize="Auto">
                        <Levels>
            ...
            <px:PXTabItem Text="Customers" BindingContext="DiscountForm" VisibleExp="DataControls[&quot;chkShowCustomers&quot;].Value == true">
                <Template>
                    <px:PXGrid ID="customersGrid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" AdjustPageSize="Auto">
                        <AutoSize Enabled="True" />
                        <Mode AllowUpload="True" />
                        <Levels>
            ...
            <px:PXTabItem Text="Customer Price Classes" BindingContext="DiscountForm" VisibleExp="DataControls[&quot;chkShowCustomerPriceClass&quot;].Value == true">
                <Template>
                    <px:PXGrid ID="customerPriceClassGrid" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" AdjustPageSize="Auto">
                        <Levels>
            ...
            <px:PXTabItem Text="Branches" BindingContext="DiscountForm" VisibleExp="DataControls[&quot;chkShowBranches&quot;].Value == true">
                <Template>
                    <px:PXGrid ID="branchesGrid" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" AdjustPageSize="Auto">
                        <Levels>
            ...
            <px:PXTabItem Text="Warehouses" BindingContext="DiscountForm" VisibleExp="DataControls[&quot;chkShowSites&quot;].Value == true">
                <Template>
                    <px:PXGrid ID="sitesGrid" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" AdjustPageSize="Auto">
                        <Levels>
