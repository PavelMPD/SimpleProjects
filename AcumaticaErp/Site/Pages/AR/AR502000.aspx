<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AR502000.aspx.cs"
    Inherits="Page_AR502000" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" TypeName="PX.Objects.AR.ARUpdateSalesPrice">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Selection" DataMember="Filter"
        ...
        <Template>
            ...
            <px:PXSelector CommitChanges="True" ID="edCustPriceClassID" runat="server" DataField="CustPriceClassID" />
        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <RowTemplate>
                    ...
                    <px:PXSelector ID="edTaxID" runat="server" DataField="TaxID" Enabled="False" />
                    <px:PXSelector ID="edLastTaxID" runat="server" DataField="LastTaxID" Enabled="False" />
                    <px:PXSelector ID="edPendingTaxID" runat="server" DataField="PendingTaxID" Enabled="False" />
                </RowTemplate>
                <Columns>
                    <px:PXGridColumn DataField="Selected" AllowCheckAll="true" TextAlign="Center" Type="CheckBox" Width="30px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="CustPriceClassID" DisplayFormat="&gt;aaaaaaaaaa" Width="90px" />
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="TaxID" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" />
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="LastTaxID" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" />
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="PendingTaxID" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
