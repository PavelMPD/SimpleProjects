...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="ARSetupRecord"
		TypeName="PX.Objects.AR.ARSetupMaint">
		<CallbackCommands>
		...
		<Items>
			<px:PXTabItem Text="General Settings">
				<Template>
					...
					<px:PXSelector ID="edBatchNumberingID" runat="server" DataField="BatchNumberingID"
						Text="BATCH" AllowEdit="True">
					</px:PXSelector>
					<px:PXSelector ID="edInvoiceNumberingID" runat="server" DataField="InvoiceNumberingID"
						Text="ARINVOICE" AllowEdit="True">
					</px:PXSelector>
					<px:PXSelector ID="edPaymentNumberingID" runat="server" DataField="PaymentNumberingID"
						Text="ARPAYMENT" AllowEdit="True">
					</px:PXSelector>
					<px:PXSelector ID="edDebitAdjNumberingID" runat="server" DataField="DebitAdjNumberingID"
						Text="ARINVOICE" AllowEdit="True">
					</px:PXSelector>
					<px:PXSelector ID="edCreditAdjNumberingID" runat="server" DataField="CreditAdjNumberingID"
						Text="ARINVOICE" AllowEdit="True">
					</px:PXSelector>
					<px:PXSelector ID="edWriteOffNumberingID" runat="server" DataField="WriteOffNumberingID"
						Text="ARINVOICE" AllowEdit="True">
					</px:PXSelector>
					<px:PXSelector ID="edFinChargeNumberingID" runat="server" DataField="FinChargeNumberingID"
						Text="ARINVOICE" AllowEdit="True">
					</px:PXSelector>
					...
					<px:PXLabel Size="xs" ID="Label1" runat="server" Text="Periods"></px:PXLabel>
					<px:PXLayoutRule runat="server" />
					<px:PXCheckBox SuppressLabel="True" ID="chkAutoPost" runat="server" DataField="AutoPost"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkSummaryPost" runat="server" DataField="SummaryPost"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkZeroPost" runat="server" DataField="ZeroPost"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Data Entry Settings" />
					<px:PXSelector ID="edDfltCustomerClassID" runat="server" AllowEdit="True" DataField="DfltCustomerClassID"
						CommitChanges="true">
					</px:PXSelector>
					...
					<px:PXCheckBox SuppressLabel="True" ID="chkHoldEntry" runat="server" Checked="True"
						DataField="HoldEntry" AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkRequireControlTotal" runat="server" Checked="True"
						DataField="RequireControlTotal" AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkCreditCheckError" runat="server" DataField="CreditCheckError"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkPrintBeforeRelease" runat="server" DataField="PrintBeforeRelease"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkEmailBeforeRelease" runat="server" DataField="EmailBeforeRelease"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="M" />
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Data Processing Settings" />
					<px:PXCheckBox SuppressLabel="True" ID="chkIntegratedCCProcessing" runat="server"
						DataField="IntegratedCCProcessing" AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXSelector ID="edPaymentAutoProcessingTermsID" runat="server" DataField="PaymentAutoProcessingTermsID">
					</px:PXSelector>
					<px:PXCheckBox SuppressLabel="True" ID="chkAutoApplyPayments" runat="server" DataField="AutoApplyPayments"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkAgeCredits" runat="server" DataField="AgeCredits"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkDefFinChargeFromCycle" runat="server"
						DataField="DefFinChargeFromCycle" AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkFinChargeOnCharge" runat="server" DataField="FinChargeOnCharge"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkFinChargeFirst" runat="server" DataField="FinChargeFirst"
						AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					...
					<px:PXCheckBox CommitChanges="True" SuppressLabel="True" Height="17px" ID="chkConsolidatedStatement"
						runat="server" DataField="ConsolidatedStatement" AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
					<px:PXSegmentMask ID="edStatementBranchID" runat="server" DataField="StatementBranchID">
					</px:PXSegmentMask>
					<px:PXCheckBox CommitChanges="True" SuppressLabel="True" ID="chkConsolidatedDunningLetter"
						runat="server" DataField="ConsolidatedDunningLetter" AlignLeft="True" Size="Empty">
					</px:PXCheckBox>
            ...
            <px:PXTabItem Text="Price/Discount Calculation">
                <Template>
                    ...
                    <px:PXSelector ID="edDefaultRateTypeID" runat="server" 
                        DataField="DefaultRateTypeID" AllowEdit="True" edit="1" />
			...
			<px:PXTabItem Text="Dunning Settings">
				<Template>
					<px:PXGrid ID="gridNS" runat="server" SkinID="DetailsInTab" Width="100%" Height="150px"
						AdjustPageSize="Auto" AllowPaging="True" TabIndex="200" DataSourceID="ds">
						...
						<Levels>
							<px:PXGridLevel DataMember="DunningSetup">
								<RowTemplate>
									...
									<px:PXNumberEdit ID="edDunningLetterLevel" runat="server" DataField="DunningLetterLevel">
									</px:PXNumberEdit>
									<px:PXNumberEdit ID="edDueDays" runat="server" DataField="DueDays" CommitChanges="true">
									</px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edDaysToSettle" runat="server" DataField="DaysToSettle" CommitChanges="true">
									</px:PXNumberEdit>
								</RowTemplate>
								<Columns>
									...
									<px:PXGridColumn DataField="DueDays" Label="Due Days" TextAlign="Right" Width="100px" CommitChanges="true">
									</px:PXGridColumn>
                                    <px:PXGridColumn DataField="DaysToSettle" Label="Due Days" TextAlign="Right" Width="100px" CommitChanges="true">
									</px:PXGridColumn>
