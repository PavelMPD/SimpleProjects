...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edPayDate">
        ...
        <Template>
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="210px" ControlSize="S" />
            <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Document Selection Criteria" />
            ...
            <px:PXLabel Size="xs" ID="lblOverDueFor" runat="server" Height="18px">Days or More</px:PXLabel>
            ...
            <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Additional Selection Criteria" />
            ...
            <pxa:PXCurrencyRate DataField="CuryID" ID="edCury" runat="server" DataSourceID="ds" RateTypeView="_PayBillsFilter_CurrencyInfo_" DataMember="_Currency_">
            </pxa:PXCurrencyRate>
    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="288px" Style="z-index: 100; left: 0px; top: 0px;" Width="100%" Caption="Payment Details" AllowPaging="true"
        ...
        <Levels>
            <px:PXGridLevel DataMember="ARDocumentList">
                ...
                <Columns>
                    <px:PXGridColumn AllowNull="False" DataField="Selected" Width="20px" TextAlign="Center" Type="CheckBox" AllowCheckAll="True" AllowSort="False" AllowMove="False"
