...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXTab ID="tab1" runat="server" DataSourceID="ds1" Height="432px" Style="z-index: 100"
		...
		<Items>
			...
			<px:PXTabItem Text="Scripts">
				<Template>
					<px:PXGrid ID="gridAnalytics" runat="server" ActionsPosition="Top" DataSourceID="ds1"
						Width="100%" AdjustPageSize="Auto" Height="54px" SkinID="Details">
						<Levels>
							<px:PXGridLevel DataKeyNames="PageID,NPageID" DataMember="Analytics">
								<RowTemplate>
									<px:PXLabel ID="lblNPageID" runat="server" Style="z-index: 100; left: 9px; position: absolute;
										top: 9px">NPageID :</px:PXLabel>
									<px:PXSelector ID="edNPageID" runat="server" DataField="NPageID" DataKeyNames="PageID"
										DataMember="_WikiNotificationTemplate_" DataSourceID="ds1" LabelID="lblNPageID"
										Style="z-index: 101; left: 126px; position: absolute; top: 9px" TabIndex="-1"
										Width="108px" ValueField="Name">
										<GridProperties>
											<Columns>
								...
								<Columns>
									<px:PXGridColumn DataField="NPageID" Width="200px">
										<Header Text="NPageID">
										</Header>
									</px:PXGridColumn>
								</Columns>
