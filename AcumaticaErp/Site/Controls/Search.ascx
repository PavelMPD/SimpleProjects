<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Controls_SearchNew" %>
...
<div style="background-color: White">
    <px:PXFormView ID="PXFormView1" runat="server" CaptionVisible="False" Style="position: static;" Width="100%" AllowFocus="False">
        <Template>
            <div style="padding: 5px; position: static; border-style: none;">
                <table runat="server" style="position: static; margin-left: 5px; border-color: #ECE9E8; width: 600px;">
                                ...
                                <tr>
                                    ...
                                    <td style="height: 20px; white-space: nowrap">
                                        <px:PXTextEdit ID="txtSearch" runat="server" Style="position: static;"
                                            ToolTip="Search for Wiki articles." Width="295px" MaxLength="255">
                                            <ClientEvents KeyDown="txtSearch_KeyDown" />
                                        </px:PXTextEdit>
                                    </td>

                                    <td style="height: 20px; white-space: nowrap">
                                        <px:PXLabel runat="server" ID="PXLabel1" Text="in" Style="white-space: nowrap; margin-left: 1px" Width="12px"></px:PXLabel>
                                    </td>

                                    <td style="height: 20px; white-space: nowrap">
                                        <px:PXDropDown ID="GlobalSearchCaption" runat="server" Style="height: 20px; width: 137px" OnCallBack="GlobalSearchCaption_Change">
                                            <AutoCallBack Command="GlobalSearchCaption_Change" Target="ds">
                    ...
                    <tr id="filterrow" runat="server">
                        <td>
                            <table style="position: static; height: 20px;">
                                <tr>
                                    <td style="height: 20px; padding-right: 25px; white-space: nowrap">
                                    ...
                                    <td style="height: 20px; white-space: nowrap">
                                        <px:PXDropDown ID="SearchCaption" runat="server" Style="height: 20px; width: 137px" OnCallBack="SearchCaption_WikiChange">
                                    ...
                                    <td style="height: 20px; white-space: nowrap">
                                        <px:PXDropDown ID="SearchCaptionCategory" runat="server" Style="height: 20px; margin-left: 17px; width: 137px;" OnCallBack="SearchCaption_CategoryChange">
                                    ...
                                    <td style="height: 20px; white-space: nowrap">
                                        ...
                                        <px:PXDropDown ID="SearchCaptionProduct" runat="server" Style="height: 20px; margin-left: 17px; width: 137px" OnCallBack="SearchCaption_ProductChange">
