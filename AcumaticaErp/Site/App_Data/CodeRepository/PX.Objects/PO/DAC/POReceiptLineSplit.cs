namespace PX.Objects.PO
{
	...
	public partial class POReceiptLineSplit : PX.Data.IBqlTable, ILSDetail
	{
		...
		[PXDBScalar(typeof(Search<POReceiptLine.pONbr, Where<POReceiptLine.receiptNbr, Equal<POReceiptLineSplit.receiptNbr>, And<POReceiptLine.lineNbr, Equal<POReceiptLineSplit.lineNbr>>>>))]
		public string PONbr
		{
			get
			{
		...
		[PXDBScalar(typeof(Search<POReceiptLine.receiptType, Where<POReceiptLine.receiptNbr, Equal<POReceiptLineSplit.receiptNbr>, And<POReceiptLine.lineNbr, Equal<POReceiptLineSplit.lineNbr>>>>))]
		...
		[PXDBScalar(typeof(Search<POReceiptLine.lineType, Where<POReceiptLine.receiptNbr, Equal<POReceiptLineSplit.receiptNbr>, And<POReceiptLine.lineNbr, Equal<POReceiptLineSplit.lineNbr>>>>))]
		...
		[INLotSerialNbr(typeof(POReceiptLineSplit.inventoryID), typeof(POReceiptLineSplit.subItemID), typeof(POReceiptLineSplit.locationID), typeof(POReceiptLine.lotSerialNbr))]
