...
namespace PX.Objects.CM
{
	...
	public class CuryRateMaint : PXGraph<CuryRateMaint>
	{
		...
		protected virtual void CurrencyRate_FromCuryID_FieldUpdating(PXCache cache, PXFieldUpdatingEventArgs e)
		{
			...
			{
                cache.RaiseExceptionHandling("FromCuryID", e.Row, e.NewValue, new PXSetPropertyException("The destination currency should be different from the source currency."));
