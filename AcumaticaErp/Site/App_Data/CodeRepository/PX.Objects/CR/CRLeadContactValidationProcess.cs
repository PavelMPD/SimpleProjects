...
namespace PX.Objects.CR
{
	...
	public class CRLeadContactValidationProcess : PXGraph<CRLeadContactValidationProcess>
	{
		...
		private static void ProcessValidation(ValidationFilter Filter, Contact record)
		{
				...
				{
					EPActivity activity = PXSelect<EPActivity, Where<EPActivity.refNoteID, Equal<Required<Contact.noteID>>>>.SelectWindowed(graph, 0, 1, contact.NoteID);
					if (activity == null)
					{
	...
	public partial class CRDuplicateRecord : IBqlTable
	{
		...
		[PXUIEnabled(typeof(Switch<Case<Where<Selector<CRDuplicateRecord.duplicateContactID, Contact.contactType>, NotEqual<ContactTypesAttribute.bAccountProperty>,
			And<Selector<CRDuplicateRecord.duplicateContactID, Contact.contactType>, NotEqual<ContactTypesAttribute.employee>>>, True>, False>))]
