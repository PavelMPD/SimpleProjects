...
{
	public class UpdateCaseMassProcess : CRBaseUpdateProcess<UpdateCaseMassProcess, CRCase, PXMassUpdatableFieldAttribute, CRCase.caseClassID, CSAnswerType.caseAnswerType>
	{
