...
namespace PX.Objects.IN
{
	public class INAccessDetail : PX.SM.UserAccess
	{
		...
		[PXDimensionSelector(SiteAttribute.DimensionName, typeof(INSite.siteCD), typeof(INSite.siteCD))]
	...
	public class INAccessItem : PX.SM.BaseAccess
	{
		...
		[PXSelector(typeof(INItemClass.itemClassID))]
		protected virtual void INItemClass_ItemClassID_CacheAttached(PXCache sender)
		{
		}
	...
	public class INAccessDetailItem : PX.SM.UserAccess
	{
		...
		public INAccessDetailItem()
		{
			...
			Class.Cache.AllowInsert = false;
			PXUIFieldAttribute.SetEnabled(Class.Cache, null, false);
			PXUIFieldAttribute.SetEnabled<INItemClass.itemClassID>(Class.Cache, null);
