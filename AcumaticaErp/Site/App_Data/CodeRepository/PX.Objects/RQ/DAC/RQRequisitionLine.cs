...
using PX.Objects.PO;
	...
	public partial class RQRequisitionLine : PX.Data.IBqlTable
	{
		...
		[PXDBCurrency(typeof(Search<INSetup.decPlPrcCst>), typeof(RQRequisitionLine.curyInfoID), typeof(RQRequisitionLine.estUnitCost))]
		...
		[Account(DisplayName = "Account", 
			Visibility = PXUIVisibility.Visible, Filterable = false, DescriptionField=typeof(Account.description), Enabled = false)]		
		...
		[SubAccount(typeof(RQRequisitionLine.expenseAcctID), DisplayName = "Sub.", Visibility = PXUIVisibility.Visible, Filterable = true, DescriptionField=typeof(Sub.description), Enabled = false)]		
