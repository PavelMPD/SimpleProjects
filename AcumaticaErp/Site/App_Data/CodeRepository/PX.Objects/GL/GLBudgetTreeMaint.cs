...
namespace PX.Objects.GL
{
	public class GLBudgetTreeMaint : PXGraph<GLBudgetTreeMaint>
	{
		...
		public PXSelect<GLBudgetTree, Where<GLBudgetTree.parentGroupID, Equal<Argument<int?>>>, OrderBy<Asc<GLBudgetTree.sortOrder>>> Tree;
		...
		)
		{
			...
			foreach (GLBudgetTree node in PXSelect<GLBudgetTree,
				Where<GLBudgetTree.parentGroupID,
				Equal<Required<GLBudgetTree.parentGroupID>>,
