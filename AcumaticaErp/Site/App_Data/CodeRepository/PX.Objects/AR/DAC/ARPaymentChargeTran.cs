...
namespace PX.Objects.AR
{
	...
	public class ARPaymentChargeTran : PX.Data.IBqlTable
	{
        ...
        [PXLineNbr(typeof(ARPayment.chargeCntr))]
        ...
        [PXDBInt()]
        [PXDefault(typeof(ARPayment.cashAccountID))]
        ...
        [PXDefault(typeof(ARPayment.adjFinPeriodID))]
        ...
        [PXDBString(6, IsFixed = true)]
        [PXDefault(typeof(ARPayment.adjTranPeriodID))]
        ...
        [PXUnboundFormula(typeof(Switch<Case<Where<ARPaymentChargeTran.consolidate, Equal<True>>, ARPaymentChargeTran.curyTranAmt>, decimal0>), typeof(SumCalc<AR.Standalone.ARCashSale.curyConsolidateChargeTotal>))]
