...
namespace PX.Objects.AR
{
	public class CustomerClassMaint : PXGraph<CustomerClassMaint, CustomerClass>
	{
		...
		{						
			...
			PXUIFieldAttribute.SetVisible<CustomerClass.curyID>(cache, null, (bool)CMSetup.Current.MCActivated);
			PXUIFieldAttribute.SetVisible<CustomerClass.curyRateTypeID>(cache, null, (bool)CMSetup.Current.MCActivated);
			PXUIFieldAttribute.SetVisible<CustomerClass.printCuryStatements>(cache, null, (bool)CMSetup.Current.MCActivated);
			PXUIFieldAttribute.SetVisible<CustomerClass.allowOverrideCury>(cache, null, (bool)CMSetup.Current.MCActivated);
			PXUIFieldAttribute.SetVisible<CustomerClass.allowOverrideRate>(cache, null, (bool)CMSetup.Current.MCActivated);
    	}
		...
		{
			if (CMSetup.Current.MCActivated == false)
			{
				e.NewValue = null;
				e.Cancel = true;
			}
