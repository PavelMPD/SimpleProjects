...
namespace PX.Objects.AR
{
	...
	public class ARSPCommissionProcess:  PXGraph<ARSPCommissionProcess>
	{
		...
		#region Buttons
		public PXAction<ARSPCommissionPeriod> cancel;
		...
		protected virtual IEnumerable toprocess() 
		{
			...
			else
			{
                using (new PXReadBranchRestrictedScope())
                {
                    ...
                    {
                        ARSalesPerTranExt spTotal = (ARSalesPerTranExt)iSPT;
	...
	public class ARSPCommissionReview : PXGraph<ARSPCommissionProcess>
	{
		...
		public PXAction<ARSPCommissionPeriod> viewDetails;
		...
		public PXSelect<ARSPCommissionPeriod> Filter;
		[PXFilterable]
		public PXSelectGroupBy<ARSPCommnHistory, Where<ARSPCommnHistory.commnPeriod, Equal<Current<ARSPCommissionPeriod.commnPeriodID>>>, Aggregate<GroupBy<ARSPCommnHistory.salesPersonID, Sum<ARSPCommnHistory.commnblAmt, Sum<ARSPCommnHistory.commnAmt>>>>> ToProcess;
		...
		protected virtual void ARSPCommissionPeriod_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			ARSPCommissionPeriod closedOrPrepared = PXSelect<ARSPCommissionPeriod, Where<ARSPCommissionPeriod.commnPeriodID, Greater<Required<ARSPCommissionPeriod.commnPeriodID>>,
													And<ARSPCommissionPeriod.status, NotEqual<ARSPCommissionPeriodStatus.open>>>>.SelectWindowed(this, 0, 1, row.CommnPeriodID);
