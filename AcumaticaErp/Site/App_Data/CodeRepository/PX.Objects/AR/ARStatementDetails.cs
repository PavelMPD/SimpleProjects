...
namespace PX.Objects.AR
{
	...
	public class ARStatementDetails : PXGraph<ARStatementDetails>
    {
		...
		/*
		public PXAction<ARStatementDetailsParameters> printStatement;
		[PXUIField(DisplayName = "Print Statement", MapEnableRights = PXCacheRights.Select, MapViewRights = PXCacheRights.Select)]
		[PXLookupButton]
		public virtual IEnumerable PrintStatement(PXAdapter adapter)
		{
			if (this.Filter.Current != null)
			{
				Dictionary<string, string> parameters = new Dictionary<string, string>();
				Export(parameters, this.Filter.Current);
				parameters[ARStatementReportParams.Fields.PrintStatements] = ARStatementReportParams.BoolValues.True;
				parameters[ARStatementReportParams.Fields.SendStatementsByEmail] = ARStatementReportParams.BoolValues.False;
				throw new PXReportRequiredException(parameters, ARStatementReportParams.CS_StatementReportID, "AR Statement Report");
			}
			return Filter.Select();
		}

		public PXAction<ARStatementDetailsParameters> printCuryStatement;
		[PXUIField(DisplayName = "Print Cury. Statement", MapEnableRights = PXCacheRights.Select, MapViewRights = PXCacheRights.Select)]
		[PXLookupButton]
		public virtual IEnumerable PrintCuryStatement(PXAdapter adapter)
		{
			if (this.Filter.Current != null)
			{
				Dictionary<string, string> parameters = new Dictionary<string, string>();
		...
		public PXAction<ARStatementDetailsParameters> mailStatement;
		[PXUIField(DisplayName = "Email Statement", MapEnableRights = PXCacheRights.Select, MapViewRights = PXCacheRights.Select)]
		[PXLookupButton]
		public virtual IEnumerable MailStatement(PXAdapter adapter)
		{
			if (this.Filter.Current != null)
			{
				Dictionary<string, string> parameters = new Dictionary<string, string>();
				Export(parameters, this.Filter.Current);
				parameters[ARStatementReportParams.Fields.PrintStatements] =ARStatementReportParams.BoolValues.False ;
		...
		public PXAction<ARStatementDetailsParameters> mailCuryStatement;
				
		[PXUIField(DisplayName = "Email Multicurrency Statement", MapEnableRights = PXCacheRights.Select, MapViewRights = PXCacheRights.Select)]
		[PXLookupButton]
		public virtual IEnumerable MailCuryStatement(PXAdapter adapter)
		{
			if (this.Filter.Current != null)
			{
				Dictionary<string, string> parameters = new Dictionary<string, string>();
