...
namespace PX.Objects.EP
{
	...
	public partial class EPEquipment : PX.Data.IBqlTable, IAttributeSupport
	{
		#region EquipmentID
		...
		[PXDBInt]
		[PXSelector(typeof(Search<FixedAsset.assetID, Where<FixedAsset.recordType, NotEqual<FARecordType.classType>>>), DescriptionField = typeof(FixedAsset.description))]
		...
		#region Attributes
		[CRAttributesField(typeof(CSAnswerType.equipmentAnswerType), typeof(EPEquipment.equipmentID), typeof(EPEquipment.classID))]
		...
		{
			get { return CSAnswerType.Equipment; }
		}
