...
<body>
	<form id="form1" runat="server" autocomplete="off" enctype="multipart/form-data">
		<px:PXSmartPanel ID="panelT" runat="server" SkinID="Frame" Overflow="Hidden">
			<table cellpadding="0" cellspacing="0" style="width:100%" class="toolSysTable">
				...
				<td class="fill" style="overflow: hidden">
			...
			<tr>
				<td class="leftFrame" runat="server" style="width: 20%">
					...
					<div class="searchFrame">
						<px:PXSearchBox ID="searchBox" runat="server" Target="main" ButtonText="Search" />
					</div>
					<div runat="server" id="divNavPanel" style="padding: 4px; display: none" />
					
					<px:PXSmartPanel ID="panelL" runat="server" SkinID="Frame" CssClass="menuFrameO" AutoSize-Enabled="true">
							<px:PXSmartPanel ID="menuPanel" runat="server" AutoSize-Enabled="true" SkinID="Frame" 	CssClass="menuFrameI">
				...
				<td class="rightFrame" style="width: 81%">
					...
					<px:PXSmartPanel ID="panelR" runat="server" SkinID="Frame" AutoSize-Enabled="true" CssClass="SmartPanelF screenFrame"
		...
		<px:PXSmartPanel ID="pnlDate" runat="server" Width="240px" DesignView="Hidden"
			CaptionVisible="False" LoadOnDemand="True" Position="UnderOwner" ActiveControlID="edEffDate" 
			...
			<px:PXPanel runat="server" ID="pnlDateButtons" RenderStyle="Simple" ContentLayout-Layout="Stack" 
				ContentLayout-ContentAlign="Right" ContentLayout-Orientation="Horizontal">
